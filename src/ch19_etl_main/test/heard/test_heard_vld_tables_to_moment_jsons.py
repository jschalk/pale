...
def test_get_moment_heard_select1_sqlstrs_ReturnsObj(cursor0: Cursor):
    ...
    mmtpayy_h_vld = create_prime_tablename(mmtpayy_abbv7, "h_vld")
    momentbud_h_vld = create_prime_tablename(momentbud_abbv7, "h_vld")
    mmthour_h_vld = create_prime_tablename(mmthour_abbv7, "h_vld")
    mmtmont_h_vld = create_prime_tablename(mmtmont_abbv7, "h_vld")
    mmtweek_h_vld = create_prime_tablename(mmtweek_abbv7, "h_vld")
    mmtoffi_h_vld = create_prime_tablename(mmtoffi_abbv7, "h_vld")
    momentunit_h_vld = create_prime_tablename(momentunit_abbv7, "h_vld")
...
def test_etl_heard_vld_tables_to_moment_jsons_Scenario0_CreateFilesWithOnlyMomentRope(
    ...
    momentunit_h_vld_tablename = create_prime_tablename(kw.momentunit, "h_vld")
