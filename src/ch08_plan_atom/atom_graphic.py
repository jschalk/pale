...
def planatom_periodic_table0() -> plotly_Figure:
    ...
    plan_voiceunit_insert = get_insert_rect("plan_voiceunit")
    plan_voice_membership_insert = get_insert_rect("plan_voice_membership")
    ...
    plan_voiceunit_update = get_update_rect("plan_voiceunit")
    plan_voice_membership_update = get_update_rect("plan_voice_membership")
    ...
    plan_voice_membership_delete = get_delete_rect("plan_voice_membership")
    plan_voiceunit_delete = get_delete_rect("plan_voiceunit")
    planunit_update = get_update_rect("planunit")

    green_str = "Green"
    plan_voiceunit_insert.set_level(0, 0, 0.25, green_str)
    plan_voiceunit_update.set_level(0, 0.25, 0.75, green_str)
    plan_voiceunit_delete.set_level(0, 0.75, 1, green_str)
    plan_voice_membership_insert.set_level(1, 0, 0.3, green_str)
    plan_voice_membership_update.set_level(1, 0.3, 0.7, green_str)
    plan_voice_membership_delete.set_level(1, 0.7, 1, green_str)
    ...
    # Add shapes
    add_atom_rect(fig, plan_voiceunit_insert)
    add_atom_rect(fig, plan_voice_membership_insert)
    ...
    add_atom_rect(fig, plan_voiceunit_update)
    add_atom_rect(fig, plan_voice_membership_update)
    ...
    add_atom_rect(fig, plan_voice_membership_delete)
    add_atom_rect(fig, plan_voiceunit_delete)
