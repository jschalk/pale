...
def planatom_periodic_table0() -> plotly_Figure:
    ...
    plan_personunit_insert = get_insert_rect("plan_personunit")
    plan_person_membership_insert = get_insert_rect("plan_person_membership")
    ...
    plan_personunit_update = get_update_rect("plan_personunit")
    plan_person_membership_update = get_update_rect("plan_person_membership")
    ...
    plan_person_membership_delete = get_delete_rect("plan_person_membership")
    plan_personunit_delete = get_delete_rect("plan_personunit")
    planunit_update = get_update_rect("planunit")

    green_str = "Green"
    plan_personunit_insert.set_level(0, 0, 0.25, green_str)
    plan_personunit_update.set_level(0, 0.25, 0.75, green_str)
    plan_personunit_delete.set_level(0, 0.75, 1, green_str)
    plan_person_membership_insert.set_level(1, 0, 0.3, green_str)
    plan_person_membership_update.set_level(1, 0.3, 0.7, green_str)
    plan_person_membership_delete.set_level(1, 0.7, 1, green_str)
    ...
    # Add shapes
    add_atom_rect(fig, plan_personunit_insert)
    add_atom_rect(fig, plan_person_membership_insert)
    ...
    add_atom_rect(fig, plan_personunit_update)
    add_atom_rect(fig, plan_person_membership_update)
    ...
    add_atom_rect(fig, plan_person_membership_delete)
    add_atom_rect(fig, plan_personunit_delete)
