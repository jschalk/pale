...
def test_sift_atom_ReturnsObj_PlanAtom_DELETE_plan_kegunit():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    ...
    root_atom = planatom_shop(kw.plan_kegunit, kw.DELETE)
    root_atom.set_arg(kw.keg_rope, root_rope)
    casa_atom = planatom_shop(kw.plan_kegunit, kw.DELETE)
    casa_atom.set_arg(kw.keg_rope, casa_rope)
    clean_atom = planatom_shop(kw.plan_kegunit, kw.DELETE)
    clean_atom.set_arg(kw.keg_rope, clean_rope)
    sweep_atom = planatom_shop(kw.plan_kegunit, kw.DELETE)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_kegunit():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    root_rope = sue_plan.kegroot.get_keg_rope()
    casa_rope = sue_plan.make_l1_rope(exx.casa)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_awardunit():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_swim_atom = planatom_shop(kw.plan_keg_awardunit, kw.DELETE)
    casa_swim_atom.set_arg(kw.keg_rope, casa_rope)
    casa_swim_atom.set_arg(kw.awardee_title, swim_str)
    clean_swim_atom = planatom_shop(kw.plan_keg_awardunit, kw.DELETE)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_reasonunit():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_wk_atom = planatom_shop(kw.plan_keg_reasonunit, kw.DELETE)
    casa_wk_atom.set_arg(kw.keg_rope, casa_rope)
    casa_wk_atom.set_arg(kw.reason_context, wk_rope)
    clean_wk_atom = planatom_shop(kw.plan_keg_reasonunit, kw.DELETE)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_reason_caseunit_Exists():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_wk_atom = planatom_shop(kw.plan_keg_reason_caseunit, kw.DELETE)
    casa_wk_atom.set_arg(kw.keg_rope, casa_rope)
    casa_wk_atom.set_arg(kw.reason_context, wk_rope)
    casa_wk_atom.set_arg(kw.reason_state, thur_rope)
    clean_wk_atom = planatom_shop(kw.plan_keg_reason_caseunit, kw.DELETE)
    clean_wk_atom.set_arg(kw.keg_rope, clean_rope)
    clean_wk_atom.set_arg(kw.reason_context, wk_rope)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_partyunit():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_swim_atom = planatom_shop(kw.plan_keg_partyunit, kw.DELETE)
    casa_swim_atom.set_arg(kw.keg_rope, casa_rope)
    casa_swim_atom.set_arg(kw.party_title, swim_str)
    clean_swim_atom = planatom_shop(kw.plan_keg_partyunit, kw.DELETE)
    clean_swim_atom.set_arg(kw.keg_rope, clean_rope)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_healerunit():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_swim_atom = planatom_shop(kw.plan_keg_healerunit, kw.DELETE)
    casa_swim_atom.set_arg(kw.keg_rope, casa_rope)
    casa_swim_atom.set_arg(kw.healer_name, swim_str)
    clean_swim_atom = planatom_shop(kw.plan_keg_healerunit, kw.DELETE)
    clean_swim_atom.set_arg(kw.keg_rope, clean_rope)
...
def test_sift_atom_SetsPlanDeltaPlanAtom_plan_keg_factunit():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    casa_rope = sue_plan.make_l1_rope(exx.casa)
    ...
    casa_wk_atom = planatom_shop(kw.plan_keg_factunit, kw.DELETE)
    casa_wk_atom.set_arg(kw.keg_rope, casa_rope)
    casa_wk_atom.set_arg(kw.fact_context, wk_rope)
    clean_wk_atom = planatom_shop(kw.plan_keg_factunit, kw.DELETE)
    clean_wk_atom.set_arg(kw.keg_rope, clean_rope)
