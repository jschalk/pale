...
from src.ch08_plan_atom.atom_config import get_normalized_plan_table_build
from src.ch08_plan_atom.normal_model import (
    AwardUnitTable,
    CaseTable,
    FactTable,
    HealerUnitTable,
...
def test_normalized_table_PlanTable_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.planunit)
...
def test_normalized_table_PartnerUnitTable_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_partnerunit)
...
def test_normalized_table_MemberShipTable_membership_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_partner_membership)
...
def test_normalized_table_KegTable_keg_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_kegunit)
...
def test_normalized_table_AwardUnitTable_awardunit_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_awardunit)
...
def test_normalized_table_ReasonTable_reason_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_reasonunit)
...
def test_normalized_table_CaseTable_case_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_reason_caseunit)
...
def test_normalized_table_LaborLinkTable_partyunit_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_partyunit)
...
def test_normalized_table_HealerUnitTable_healerunit_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_healerunit)
...
def test_normalized_table_FactTable_fact_Exists():
    # ESTABLISH
    config_dimen = get_normalized_plan_table_build().get(kw.plan_keg_factunit)
