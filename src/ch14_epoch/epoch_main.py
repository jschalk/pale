...
def get_c400_constants() -> C400Constants:
    c400_constants_path = create_path("src/ch14_epoch", "c400_constants.json")
...
def epoch_config_path() -> str:
    "Returns path: ch14_epoch/default_epoch_config.json"

    src_dir = create_path(os_getcwd(), "src")
    chapter_dir = create_path(src_dir, "ch14_epoch")
