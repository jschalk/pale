...
CREATE_MMTBUDD_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_budunit_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, bud_time INTEGER, knot TEXT, quota REAL, celldepth INTEGER, error_message TEXT)"""
...
CREATE_MMTHOUR_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_hour_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, cumulative_minute INTEGER, hour_label TEXT, knot TEXT, error_message TEXT)"""
...
CREATE_MMTMONT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_month_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, cumulative_day INTEGER, month_label TEXT, knot TEXT, error_message TEXT)"""
...
CREATE_MMTOFFI_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_timeoffi_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, offi_time INTEGER, knot TEXT, error_message TEXT)"""
...
CREATE_MMTPAYY_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_paybook_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, contact_name TEXT, tran_time INTEGER, amount REAL, knot TEXT, error_message TEXT)"""
...
CREATE_MMTUNIT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, epoch_label TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, mana_grain REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER, error_message TEXT)"""
...
CREATE_MMTWEEK_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_weekday_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, weekday_order INTEGER, weekday_label TEXT, knot TEXT, error_message TEXT)"""
...
CREATE_NABTIME_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS nabu_timenum_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, otx_time INTEGER, inx_time INTEGER, error_message TEXT)"""
...
CREATE_PRNAWAR_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_awardunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, awardee_title_ERASE TEXT)"""
...
CREATE_PRNAWAR_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_awardunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, awardee_title TEXT, give_force REAL, take_force REAL, knot TEXT, error_message TEXT)"""
...
CREATE_PRNCASE_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_reason_caseunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, reason_context TEXT, reason_state_ERASE TEXT)"""
...
CREATE_PRNFACT_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_factunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, fact_context_ERASE TEXT)"""
...
CREATE_PRNFACT_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_factunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, fact_context TEXT, fact_state TEXT, fact_lower REAL, fact_upper REAL, knot TEXT, error_message TEXT)"""
...
CREATE_PRNHEAL_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_healerunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, healer_name_ERASE TEXT)"""
...
CREATE_PRNHEAL_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_healerunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, healer_name TEXT, knot TEXT, error_message TEXT)"""
...
CREATE_PRNLABO_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_laborunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, labor_title_ERASE TEXT)"""
...
CREATE_PRNLABO_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_laborunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, labor_title TEXT, solo INTEGER, knot TEXT, error_message TEXT)"""
...
CREATE_PRNMEMB_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_contact_membership_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, contact_name TEXT, group_title_ERASE TEXT)"""
...
CREATE_PRNMEMB_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_contact_membership_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, contact_name TEXT, group_title TEXT, group_cred_lumen REAL, group_debt_lumen REAL, knot TEXT, error_message TEXT)"""
...
CREATE_PRNPLAN_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_planunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope_ERASE TEXT)"""
...
CREATE_PRNPLAN_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_planunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, begin REAL, close REAL, addin REAL, numor INTEGER, denom INTEGER, morph INTEGER, gogo_want REAL, stop_want REAL, star INTEGER, pledge INTEGER, problem_bool INTEGER, knot TEXT, error_message TEXT)"""
...
CREATE_PRNCONT_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_contactunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, contact_name_ERASE TEXT)"""
...
CREATE_PRNCONT_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_contactunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, contact_name TEXT, contact_cred_lumen REAL, contact_debt_lumen REAL, knot TEXT, error_message TEXT)"""
...
CREATE_PRNREAS_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_reasonunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, reason_context_ERASE TEXT)"""
...
CREATE_PRNREAS_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS person_plan_reasonunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, person_name TEXT, plan_rope TEXT, reason_context TEXT, active_requisite INTEGER, knot TEXT, error_message TEXT)"""
...
CREATE_PRNUNIT_DEL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS personunit_del_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name_ERASE TEXT)"""
...
CREATE_PRNUNIT_PUT_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS personunit_put_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, moment_rope TEXT, person_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, fund_grain REAL, mana_grain REAL, respect_grain REAL, knot TEXT, error_message TEXT)"""
...
CREATE_TRLLABE_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS translate_label_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, otx_label TEXT, inx_label TEXT, otx_knot TEXT, inx_knot TEXT, unknown_str TEXT, error_message TEXT)"""
...
CREATE_TRLNAME_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS translate_name_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, otx_name TEXT, inx_name TEXT, otx_knot TEXT, inx_knot TEXT, unknown_str TEXT, error_message TEXT)"""
...
CREATE_TRLROPE_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS translate_rope_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, otx_rope TEXT, inx_rope TEXT, otx_knot TEXT, inx_knot TEXT, unknown_str TEXT, error_message TEXT)"""
...
CREATE_TRLTITL_SOUND_RAW_SQLSTR = """CREATE TABLE IF NOT EXISTS translate_title_s_raw (idea_number TEXT, spark_num INTEGER, spark_face TEXT, otx_title TEXT, inx_title TEXT, otx_knot TEXT, inx_knot TEXT, unknown_str TEXT, error_message TEXT)"""
...
def create_sound_raw_update_inconsist_error_message_sqlstr(
    ...
    if dimen.lower().startswith("moment") or dimen.lower().startswith("nabu"):
        exclude_cols = {"idea_number", "spark_num", "spark_face", "error_message"}
    else:
