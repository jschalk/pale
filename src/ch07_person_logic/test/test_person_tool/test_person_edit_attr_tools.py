...
def test_person_keg_reason_caseunit_set_obj_SetAttr_Scenario0_Pass_reason_case():
    # ESTABLISH
    ...
    assert not person_keg_reason_caseunit_exists(bob_person, wed_jkeys)

    # WHEN
    person_keg_reason_caseunit_set_obj(bob_person, wed_jkeys)

    # THEN
    assert person_keg_reason_caseunit_exists(bob_person, wed_jkeys)


def test_person_keg_reason_caseunit_set_obj_SetAttr_Scenario1_Pass_reason_lower_reason_upper():
    # ESTABLISH
    bob_person = personunit_shop(exx.bob, knot=exx.slash)
    ...
    bob_person.add_keg(dirtyness_rope)
    bob_person.add_keg(mop_rope)
    ...
    assert not person_keg_reason_caseunit_exists(bob_person, dirtyness_args)

    # WHEN
    person_keg_reason_caseunit_set_obj(person=bob_person, args=dirtyness_args)

    # THEN
    assert person_keg_reason_caseunit_exists(bob_person, dirtyness_args)
    dirtyness_case = person_keg_reason_caseunit_get_obj(bob_person, dirtyness_args)
...
def test_person_keg_reason_caseunit_set_obj_SetAttr_Scenario2_Pass_reason_divisor():
    # ESTABLISH
    bob_person = personunit_shop(exx.bob, knot=exx.slash)
    mop_rope = bob_person.make_l1_rope(exx.mop)
    clean_rope = bob_person.make_l1_rope(exx.clean)
    ...
    # WHEN
    person_keg_reason_caseunit_set_obj(bob_person, dirtyness_args)
