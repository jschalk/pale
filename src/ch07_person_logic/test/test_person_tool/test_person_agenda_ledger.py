...
def test_get_person_partner_agenda_award_csv_ReturnsObj_conpute_True():
    # ESTABLISH
    sue_person = personunit_shop("Sue")
    sue_person.add_partnerunit(exx.yao)
    sue_person.add_partnerunit(exx.bob)
...
def test_get_partner_mandate_ledger_ReturnsObj_Scenario1_conpute_True():
    # ESTABLISH
    sue_person = personunit_shop("Sue")
    ...
    # WHEN
    sue_person_settle_net_dict = get_partner_mandate_ledger(sue_person, conpute=True)
...
def test_get_partner_agenda_net_ledger_ReturnsObj_conpute_True():
    # ESTABLISH
    sue_person = personunit_shop("Sue")
    sue_person.add_partnerunit(exx.yao, 13, 5)
    sue_person.add_partnerunit(exx.bob, 5, 7)
    ...
    # WHEN
    sue_person_settle_net_dict = get_partner_agenda_net_ledger(sue_person, conpute=True)
