...
def test_get_person_config_dict_ReturnsObj_Check_populate_by_cashout():
    # ESTABLISH / WHEN
    person_config = get_person_config_dict()
...
def test_get_person_config_dict_ReturnsObj_CheckArgDataTypesCorrect():
    ...
    assert g_popcashout(cfig, prnmemb, jv, kw.fund_agenda_give) == True
    ...
    assert g_popcashout(cfig, prnmemb, jv, kw.fund_agenda_ratio_give) == True
    ...
    assert g_popcashout(cfig, prnmemb, jv, kw.fund_agenda_ratio_take) == True
    ...
    assert g_popcashout(cfig, prnmemb, jv, kw.group_cred_lumen) == False
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.fund_agenda_give) == True
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.fund_agenda_ratio_give) == True
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.fund_agenda_ratio_take) == True
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.inallocable_partner_debt_lumen) == True
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.irrational_partner_debt_lumen) == True
    ...
    assert g_popcashout(cfig, prnptnr, jv, kw.partner_cred_lumen) == False
    ...
    assert g_popcashout(cfig, prngrou, jv, kw.fund_agenda_give) == True
    ...
    assert g_popcashout(cfig, prncase, jk, kw.reason_context) == False
    ...
    assert g_popcashout(cfig, prnlabo, jk, kw.party_title) == False
