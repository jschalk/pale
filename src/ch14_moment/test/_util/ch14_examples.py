...
def create_example_moment2() -> MomentUnit:
    ...
    yao_gut_plan.add_partnerunit(exx.yao, 34, 600)
    yao_gut_plan.add_partnerunit(exx.zia, 57, 300)
    yao_gut_plan.add_partnerunit(wei_str, 10, 100)
    wei_gut_plan.add_partnerunit(exx.yao, 37, 100)
    wei_gut_plan.add_partnerunit(wei_str, 11, 400)
    wei_gut_plan.add_partnerunit(exx.zia, 27, 250)
    zia_gut_plan.add_partnerunit(exx.yao, 14, 100)
    zia_gut_plan.add_partnerunit(exx.zia, 38, 400)
    texas_str = "Texas"
