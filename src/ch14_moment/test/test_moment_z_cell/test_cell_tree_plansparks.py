...
def test_load_cells_planspark_SetsFiles_Scenario0_NoFacts(
    ...
    spark300 = 300
    time5 = 5
    save_arbitrary_planspark(moment_mstr_dir, exx.a23, exx.bob, spark300)
    ...
    # WHEN
    load_cells_planspark(moment_mstr_dir, exx.a23)
...
def test_load_cells_planspark_SetsFiles_Scenario1_WithFacts(
    ...
    save_arbitrary_planspark(moment_mstr_dir, exx.a23, exx.bob, spark300, facts=x_facts)
    bob3_planspark_path = create_planspark_path(
        moment_mstr_dir, exx.a23, exx.bob, spark300
    )
    print(f"{bob3_planspark_path=}")
