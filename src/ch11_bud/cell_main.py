...
class CellUnit:
    ...
    _partner_mandate_ledger: dict[PlanName, FundNum] = None
    ...
    def _set_partner_mandate_ledger(self):
        ...
        self._partner_mandate_ledger = get_partner_mandate_ledger(self.planadjust, True)
...
def create_child_cellunits(parent_cell: CellUnit) -> list[CellUnit]:
    ...
    x_list = []
    for child_plan_name in sorted(parent_cell._partner_mandate_ledger):
        child_mandate = parent_cell._partner_mandate_ledger.get(child_plan_name)
