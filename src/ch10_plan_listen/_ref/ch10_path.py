...
def create_keep_rope_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\kegroot\\level1_label"""
...
def create_keep_dutys_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\dutys"""
...
def create_keep_duty_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\dutys\\duty_plan.json"""
...
def create_keep_visions_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\visions"""
    x_keep_path = create_keep_rope_path(
        moment_mstr_dir, plan_name, moment_rope, keep_rope, knot
    )
...
def create_keep_grades_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\grades"""
    x_keep_path = create_keep_rope_path(
        moment_mstr_dir, plan_name, moment_rope, keep_rope, knot
    )
...
def create_keep_grade_path(
    ...
    """Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\grades\\grade_plan_name.json"""
...
def create_treasury_db_path(
    ...
    "Returns path: moment_mstr_dir\\moments\\moment_rope\\plans\\plan_name\\keeps\\level1\\treasury.db"
