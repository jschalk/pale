...
#     bob_belief.edit_keg_attr(zeit_rope, begin=0, begin=0, close=500400300)
#     bob_belief.edit_keg_attr(jour_rope, denom=1000)
#     mop_jourly_args = {
...
#     }
#     _keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: })
#     set__cases_by_args_dict(bob_belief, mop_jourly_args)
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_jourly_args)
#     jour_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_jourly_args)
#     x__frame_min = 100
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_jourly_args)
#     jour_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_jourly_args)
#     jour_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.jour_rope})
#     x__frame_min = 1000
#     assert jour_case.reason_lower == 600
#     assert jour_case.reason_upper == 690
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_xjours_args)
#     jours_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.jours_rope})
#     jours_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_xjours_args)
#     x__frame_min = 5000
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_wkly_args)
#     wk_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_wkly_args)
#     wk_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.wk_rope})
#     x__frame_min = 100
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_xwks_args)
#     xwks_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_xwks_args)
#     wks_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.wks_rope})
#     x__frame_min = 24000
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_mnthjour_args)
#     yr_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.two_yr_rope})
#     mnthjour_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_mnthjour_args)
...
#         kw.reason_state: geo_rope,
#     }
#     assert belief_keg_reason_caseunit_exists(bob_belief, geo_mnth_args)
#     geo_case = belief_keg_reason_caseunit_get_obj(bob_belief, geo_mnth_args)
#     yr_keg = belief_kegunit_get_obj(bob_belief, {kw.keg_rope: wx.two_yr_rope})
...
#     _keg = belief_kegunit_get_obj(bob_belief, _args)
#     print(f"{get_range_attrs(_keg)=}")
#     _case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_range_args)
...
#     assert belief_keg_reason_caseunit_exists(bob_belief, mop_range_args)
#     _args = {kw.keg_rope: wx.two_rope}
#     two_reason = belief_keg_reasonunit_get_obj(bob_belief, mop_range_args)
#     _keg = belief_kegunit_get_obj(bob_belief, _args)
#     print(f"{get_range_attrs(_keg)=}")
#     _length = _keg.close
#     _case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_range_args)
...
#     _keg = belief_kegunit_get_obj(bob_belief, _args)
#     assert belief_keg_factunit_exists(bob_belief, root_two_args)
#     root_two_fact = belief_keg_factunit_get_obj(bob_belief, root_two_args)
#     x__frame_min = 10005
...
#     # ESTABLISH
#     bob_belief = get_bob_two_belief()
#     add__kegunit(bob_belief, get_lizzy9_config())
...
#     two_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_two_args)
...
#     two_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_range_args)
