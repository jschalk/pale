...
#     # ESTABLISH
#     bob_belief = beliefunit_shop()
#     mop_rope = bob_belief.make_l1_rope(exx.mop)
#     bob_belief.add_plan(mop_rope, pledge=True)
#     zeit_rope = bob_belief.make_l1_rope("zeit")
#     jour_rope = bob_belief.make_rope(zeit_rope, "jour")
#     bob_belief.edit_plan_attr(zeit_rope, begin=0, begin=0, close=500400300)
#     bob_belief.edit_plan_attr(jour_rope, denom=1000)
#     mop_jourly_args = {
...
#     }
#     _plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: })
#     set__cases_by_args_dict(bob_belief, mop_jourly_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_jourly_args)
#     jour_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_jourly_args)
#     x__frame_min = 100
...
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_jourly_args)
#     jour_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_jourly_args)
#     jour_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.jour_rope})
#     x__frame_min = 1000
#     assert jour_case.reason_lower == 600
#     assert jour_case.reason_upper == 690
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_xjours_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_xjours_args)
#     jours_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.jours_rope})
#     jours_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_xjours_args)
#     x__frame_min = 5000
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_wkly_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_wkly_args)
#     wk_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_wkly_args)
#     wk_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.wk_rope})
#     x__frame_min = 100
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_xwks_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_xwks_args)
#     xwks_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_xwks_args)
#     wks_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.wks_rope})
#     x__frame_min = 24000
...
#     # ESTABLISH
#     bob_belief = get_bob_two_belief()
#     geo_rope = bob_belief.make_rope(wx.two_yr_rope, wx.Geo)
#     mop_mnthjour_args = {
#         kw.plan_rope: wx.mop_rope,
#         kw._label: wx.two_str,
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_mnthjour_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_mnthjour_args)
#     yr_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.two_yr_rope})
#     mnthjour_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_mnthjour_args)
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_mnthly_args)
#     geo_mnth_args = {
#         kw.plan_rope: wx.mop_rope,
#         kw._label: wx.two_str,
...
#         kw.reason_state: geo_rope,
#     }
#     assert belief_plan_reason_caseunit_exists(bob_belief, geo_mnth_args)
#     geo_case = belief_plan_reason_caseunit_get_obj(bob_belief, geo_mnth_args)
#     yr_plan = belief_planunit_get_obj(bob_belief, {kw.plan_rope: wx.two_yr_rope})
...
#     }
#     set__cases_by_args_dict(bob_belief, mop_range_args)
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_range_args)
#     _args = {kw.plan_rope: wx.two_rope}
#     _plan = belief_planunit_get_obj(bob_belief, _args)
#     print(f"{get_range_attrs(_plan)=}")
#     _case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_range_args)
...
#     assert belief_plan_reason_caseunit_exists(bob_belief, mop_range_args)
#     _args = {kw.plan_rope: wx.two_rope}
#     two_reason = belief_plan_reasonunit_get_obj(bob_belief, mop_range_args)
#     _plan = belief_planunit_get_obj(bob_belief, _args)
#     print(f"{get_range_attrs(_plan)=}")
#     _length = _plan.close
#     _case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_range_args)
...
#     x_lower_min = 7777
#     x_upper_min = 8000
#     bob_belief.add_fact(wx.two_rope, wx.two_rope, x_lower_min, x_upper_min)
#     root_two_args = {
#         kw.plan_rope: wx.mop_rope,
...
#     _plan = belief_planunit_get_obj(bob_belief, _args)
#     assert belief_plan_factunit_exists(bob_belief, root_two_args)
#     root_two_fact = belief_plan_factunit_get_obj(bob_belief, root_two_args)
#     x__frame_min = 10005
...
# def test_add_frame_to_beliefunit_SetsAttrs_Scenario0_OnlyFactsAndReasons():
#     # ESTABLISH
#     bob_belief = get_bob_two_belief()
#     x_rge_lower_min = 7777
#     x_range_width = 2000
...
#     # WHEN
#     add_frame_to_beliefunit(bob_belief, x__frame_min)
...
#     # ESTABLISH
#     bob_belief = get_bob_two_belief()
#     add__planunit(bob_belief, get_lizzy9_config())
#     lizzy9_str = get_lizzy9_config().get(kw._label)
#     zeit_rope = bob_belief.make_l1_rope("zeit")
#     lizzy9_rope = bob_belief.make_rope(zeit_rope, lizzy9_str)
#     x_rge_lower_min = 7777
#     x_range_width = 2000
#     mop_two_args = {
#         kw.plan_rope: wx.mop_rope,
...
#         kw.range_width: x_range_width,
#     }
#     set__cases_by_args_dict(bob_belief, mop_two_args)
#     set__cases_by_args_dict(bob_belief, mop_lizzy9_args)
#     x_lower_min = 7777
#     x_upper_min = 8000
#     bob_belief.add_fact(wx.two_rope, wx.two_rope, x_lower_min, x_upper_min)
...
#     two_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_two_args)
...
#     # WHEN
#     add_frame_to_beliefunit(
#         bob_belief, x__frame_min, required_context_subrope=wx.two_rope
#     )
...
#     two_case = belief_plan_reason_caseunit_get_obj(bob_belief, mop_range_args)
