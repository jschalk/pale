...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_UnitDoesNotErrorWithEmptyBeliefUnit():
    ...
    # WHEN
    yao_belief._set_kegtree_range_attrs()
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_DoesNotErrorWhenThereAreNoRangeKegs():
    # ESTABLISH
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_SimpleLabel():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_begin = 7
    ziet0_close = 31
    yao_belief.edit_keg_attr(root_rope, begin=ziet0_begin, close=ziet0_close)
    yao_belief._set_keg_dict()
    root_keg = yao_belief.get_keg_obj(root_rope)
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_LabelWith_denom():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_begin = 6
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_LabelWith_denom_numor():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_begin = 6
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_begin = 6
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsInitialKeg_gogo_calc_stop_calc_LabelWith_denom_addin():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_begin = 6
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_gogo_calc_stop_calc_Simple0():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    root_rope = yao_belief.kegroot.get_keg_rope()
    ziet0_str = "ziet0"
    ...
    yao_belief.set_l1_keg(ziet0_keg)

    ziet1_str = "ziet1"
    ziet1_rope = yao_belief.make_rope(ziet0_rope, ziet1_str)
    yao_belief.set_keg_obj(kegunit_shop(ziet1_str), ziet0_rope)
    ziet1_keg = yao_belief.get_keg_obj(ziet1_rope)
    root_keg = yao_belief.get_keg_obj(root_rope)
    yao_belief._set_keg_dict()
    assert not root_keg.gogo_calc
    assert not root_keg.stop_calc
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_gogo_calc_stop_calc_LabelWith_denom():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    ziet0_str = "ziet0"
    ziet0_rope = yao_belief.make_l1_rope(ziet0_str)
    ...
    ziet1_denom = 7
    ziet1_rope = yao_belief.make_rope(ziet0_rope, ziet1_str)
    yao_belief.set_keg_obj(kegunit_shop(ziet1_str, denom=ziet1_denom), ziet0_rope)
    ziet1_keg = yao_belief.get_keg_obj(ziet1_rope)
    root_rope = yao_belief.kegroot.get_keg_rope()
    root_keg = yao_belief.get_keg_obj(root_rope)
    yao_belief._set_keg_dict()
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_gogo_calc_stop_calc_LabelWith_denom_numor():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    ziet0_str = "ziet0"
    ziet0_rope = yao_belief.make_l1_rope(ziet0_str)
    ...
    yao_belief.set_keg_obj(temp_keg, ziet0_rope)
    ziet1_keg = yao_belief.get_keg_obj(ziet1_rope)
    root_rope = yao_belief.kegroot.get_keg_rope()
    root_keg = yao_belief.get_keg_obj(root_rope)
    yao_belief._set_keg_dict()
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    ziet0_str = "ziet0"
    ziet0_rope = yao_belief.make_l1_rope(ziet0_str)
...
def test_BeliefUnit_set_kegtree_range_attrs_Sets2LevelsDescendentKeg_gogo_calc_stop_calc_LabelWith_addin():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    ziet0_str = "ziet0"
    ziet0_rope = yao_belief.make_l1_rope(ziet0_str)
    ...
    ziet1_str = "ziet1"
    ziet1_rope = yao_belief.make_rope(ziet0_rope, ziet1_str)
    yao_belief.add_keg(ziet1_rope)
    ziet2_str = "ziet2"
    ziet2_rope = yao_belief.make_rope(ziet1_rope, ziet2_str)
    ziet2_addin = 5
    x_ziet2_keg = kegunit_shop(ziet2_str, addin=ziet2_addin)
    yao_belief.set_keg_obj(x_ziet2_keg, ziet1_rope)
    ziet2_keg = yao_belief.get_keg_obj(ziet2_rope)
    root_rope = yao_belief.kegroot.get_keg_rope()
    root_keg = yao_belief.get_keg_obj(root_rope)
    yao_belief._set_keg_dict()
    assert not root_keg.gogo_calc
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_gogo_calc_stop_calc_LabelWith_denom_addin():
    # ESTABLISH
    yao_belief = beliefunit_shop("Yao")
    ziet0_str = "ziet0"
    ziet0_rope = yao_belief.make_l1_rope(ziet0_str)
...
def test_BeliefUnit_set_kegtree_range_attrs_SetsDescendentKeg_When_knot_IsNonDefault():
    # ESTABLISH
