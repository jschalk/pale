...
def test_get_atom_args_class_types_ReturnsObj():
    ...
    assert x_class_types.get(kw.fact_upper) == kw.CotoNum
    assert x_class_types.get(kw.fact_lower) == kw.CotoNum
    ...
    assert x_class_types.get(kw.reason_upper) == kw.CotoNum
    assert x_class_types.get(kw.numor) == "int"
    assert x_class_types.get(kw.reason_lower) == kw.CotoNum
