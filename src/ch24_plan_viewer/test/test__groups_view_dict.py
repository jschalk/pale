...
from src.ch24_plan_viewer.test.test__persons_view_dict import add_readable
...
#     sue_believer.add_personunit(bob_str, bob_cred_lumen, bob_debt_lumen)
#     swim_str = ";swimmers"
#     bob_swim_cred_lumen = 66
#     bob_swim_debt_lumen = 77
#     yao_swim_cred_lumen = 88
#     yao_swim_debt_lumen = 99
#     yao_person = sue_believer.get_person(exx.yao)
#     bob_person = sue_believer.get_person(bob_str)
#     yao_person.add_membership(swim_str, yao_swim_cred_lumen, yao_swim_debt_lumen)
#     bob_person.add_membership(swim_str, bob_swim_cred_lumen, bob_swim_debt_lumen)
#     sue_believer.cashout()
...
#     yao_person_dict = groups_view_dict.get(exx.yao)
...
#     # yao_personunit = sue_believer.get_person(exx.yao)
#     # bob_personunit = sue_believer.get_person(bob_str)
