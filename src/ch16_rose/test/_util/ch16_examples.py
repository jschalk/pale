...
def get_sue_roseunit() -> RoseUnit:
    sue_roseunit = roseunit_shop("Sue")
    sue_roseunit.set_namemap(get_suita_namemap())
    sue_roseunit.set_titlemap(get_swim_titlemap())
    sue_roseunit.set_labelmap(get_clean_labelmap())
    sue_roseunit.set_ropemap(get_clean_ropemap())
    sue_roseunit.ropemap.labelmap = get_clean_labelmap()
    return sue_roseunit
...
def get_casa_maison_roseunit_set_by_otx2inx() -> RoseUnit:
    otx_amy45_str = "amy45"
    inx_amy87_str = "amy87"
    otx_amy45_rope = to_rope(otx_amy45_str)
    inx_amy87_rope = to_rope(inx_amy87_str)
    ...
    sue_roseunit = roseunit_shop("Sue", 7)
    rx = kw.RopeTerm
    sue_roseunit.set_otx2inx(rx, otx_amy45_rope, inx_amy87_rope)
    sue_roseunit.set_otx2inx(rx, casa_otx_rope, casa_inx_rope)
    sue_roseunit.set_otx2inx(rx, clean_otx_rope, clean_inx_rope)
    sue_roseunit.set_otx2inx(rx, sweep_otx_rope, sweep_inx_rope)
    return sue_roseunit


def get_casa_maison_roseunit_set_by_label() -> RoseUnit:
    otx_amy45_str = "amy45"
    inx_amy87_str = "amy87"
    casa_otx_str = "casa"
    casa_inx_str = "maison"
    ...
    sue_roseunit = roseunit_shop("Sue", 7)
    sue_roseunit.set_roadmap_label(otx_amy45_str, inx_amy87_str)
    sue_roseunit.set_roadmap_label(casa_otx_str, casa_inx_str)
    sue_roseunit.set_roadmap_label(clean_otx_str, clean_inx_str)
    return sue_roseunit
...
def get_rose_core_attrs_are_none_namemap() -> NameMap:
    xio_otx = "Xio"
    sue_otx = "Sue"
    bob_otx = "Bob"
    xio_inx = "Xioita"
