...
def test_set_epoch_base_case_dayly_SetsAttr_Scenario0_NoWarppingParameters():
    ...
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_dayly_args)
...
def test_set_epoch_base_case_dayly_SetsAttr_Scenario1_WarppingParameters():
    ...
    mop_day_duration = 95
    assert bob_person.keg_exists(wx.day_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_dayly_args)
    ...
    assert day_case.reason_divisor == 1440
    # for x_keg in get_sorted_keg_list(bob_person._keg_dict):
...
def test_set_epoch_base_case_xdays_SetsAttr_Scenario0_NoWarppingParameters():
    ...
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_xdays_args)
    bob_person.cashout()
    for x_keg in get_sorted_keg_list(bob_person._keg_dict):
        print(f"{x_keg.get_keg_rope()=}")
    ...
    xdays_case = person_keg_reason_caseunit_get_obj(bob_person, mop_xdays_args)
...
def test_set_epoch_base_case_weekly_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_weekly_args)
    ...
    day_case = person_keg_reason_caseunit_get_obj(bob_person, mop_weekly_args)
...
def test_set_epoch_base_case_xweeks_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    mop_week_upper = 5
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_xweeks_args)
...
def test_set_epoch_base_case_range_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_range_args)
    ...
    day_case = person_keg_reason_caseunit_get_obj(bob_person, mop_range_args)
    ...
    assert day_case.reason_divisor == bob_person.get_keg_obj(wx.five_rope).close
...
def test_set_epoch_base_case_monthday_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    #     print(f"{x_keg.get_keg_rope()=}")
    assert bob_person.keg_exists(wx.five_rope)
    assert not person_keg_reason_caseunit_exists(bob_person, mop_monthday_args)
    ...
    day_case = person_keg_reason_caseunit_get_obj(bob_person, mop_monthday_args)
    assert day_case.reason_state == month_geo_rope
    month_geo_keg = bob_person.get_keg_obj(month_geo_rope)
...
def test_set_epoch_base_case_monthday_SetsAttr_Scenario1_WrapingParameters():
    ...
    month_trump_keg = bob_person.get_keg_obj(month_trump_rope)
...
def test_set_epoch_base_case_monthly_SetsAttr_Scenario0_AllDays_within_month_range():
    ...
    assert not person_keg_reasonunit_exists(bob_person, mop_year_args)
    ...
    # THEN
    assert person_keg_reasonunit_exists(bob_person, mop_year_args)
    year_reasonunit = person_keg_reasonunit_get_obj(bob_person, mop_year_args)
