...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario0():
    # ESTABLISH
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario1():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario2():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_days_keg_Scenario0():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
    ...
    # THEN
    clean_keg = sue_personunit.get_keg_obj(clean_rope)
    print(f"{clean_keg.factheirs.keys()=}")
    print(f"{clean_keg.factheirs.get(days_rope)=}")
    assert sue_agenda.get(clean_rope)


def test_PersonUnit_get_agenda_dict_ReturnsDictWith_week_keg_Scenario0():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_week_keg_Scenario1():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_weeks_keg_Scenario0():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario0():
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario1():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario2():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def test_PersonUnit_add_time_creg_kegunit_SyncsWeekDayAndYear_Wednesday_March1_2000():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
...
def change_fact_print_attrs(x_personunit: PersonUnit, x_lower: float, x_upper: float):
    ...
    clean_keg = x_personunit.get_keg_obj(clean_rope)
...
def test_PersonUnit_add_time_creg_kegunit_SyncsWeekDayAndYear_Thursday_March2_2000():
    # ESTABLISH
    sue_personunit = personunit_shop("Sue")
    time_rope = sue_personunit.make_l1_rope(kw.time)
    creg_rope = sue_personunit.make_rope(time_rope, kw.creg)
