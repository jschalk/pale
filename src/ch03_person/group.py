...
from src.ch03_person._ref.ch03_semantic_types import FundGrain, GroupTitle, PersonName
...
class GroupUnit(GroupCore):
    memberships: dict[PersonName, MemberShip] = None  # set by PlanUnit.set_personunit()
