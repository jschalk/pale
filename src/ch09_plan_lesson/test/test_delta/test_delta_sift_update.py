...
def test_get_minimal_plandelta_ReturnsObjUPDATEPlanAtom_plan_partnerunit():
    # ESTABLISH
    old_bob_partner_cred_lumen = 34
    new_bob_partner_cred_lumen = 7
    sue_plan = planunit_shop("Sue")
    sue_plan.add_partnerunit(exx.bob, old_bob_partner_cred_lumen)
    ...
    assert len(partners_plandelta.get_sorted_planatoms()) == 2
