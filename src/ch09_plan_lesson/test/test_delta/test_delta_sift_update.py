...
def test_get_minimal_plandelta_ReturnsObjUPDATEPlanAtom_plan_voiceunit():
    # ESTABLISH
    old_bob_voice_cred_lumen = 34
    new_bob_voice_cred_lumen = 7
    sue_plan = planunit_shop("Sue")
    sue_plan.add_voiceunit(exx.bob, old_bob_voice_cred_lumen)
    ...
    assert len(voices_plandelta.get_sorted_planatoms()) == 2
