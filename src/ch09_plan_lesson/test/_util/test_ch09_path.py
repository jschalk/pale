...
def test_create_moment_plans_dir_path_ReturnsObj():
    ...
    # WHEN
    gen_plans_dir = create_moment_plans_dir_path(x_moment_mstr_dir, A23_LASSO)
...
def test_create_plan_dir_path_ReturnsObj():
    ...
    # WHEN
    sue_dir = create_plan_dir_path(x_moment_mstr_dir, A23_LASSO, exx.sue)
...
def test_create_gut_path_ReturnsObj():
    ...
    # WHEN
    gen_a23_e3_plan_path = create_gut_path(x_moment_mstr_dir, A23_LASSO, exx.bob)
...
def test_create_job_path_ReturnsObj():
    ...
    # WHEN
    gen_a23_e3_plan_path = create_job_path(x_moment_mstr_dir, A23_LASSO, exx.bob)
