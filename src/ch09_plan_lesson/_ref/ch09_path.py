...
def create_moment_dir_path(moment_mstr_dir: str, moment_rope: MomentRope) -> str:
    """Returns path: moment_mstr_dir\\moments\\moment_rope"""
    moments_dir = create_path(moment_mstr_dir, "moments")
    return create_path(moments_dir, moment_rope)


def create_moment_json_path(moment_mstr_dir: str, moment_rope: MomentRope) -> str:
...
def create_moment_plans_dir_path(moment_mstr_dir: str, moment_rope: MomentRope) -> str:
...
def create_plan_dir_path(
    moment_mstr_dir: str, moment_rope: MomentRope, plan_name: PlanName
) -> str:
...
def create_gut_path(moment_mstr_dir: str, moment_rope: MomentRope, plan_name: PlanName):
...
def create_job_path(moment_mstr_dir: str, moment_rope: MomentRope, plan_name: PlanName):
