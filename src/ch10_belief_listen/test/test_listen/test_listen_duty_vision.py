...
def get_example_yao_belief() -> BeliefUnit:
    yao_speaker = beliefunit_shop(exx.yao, ch10_example_moment_label())
...
def get_example_yao_gut_with_3_healers():
    ...
    iowa_keg.healerunit.set_healer_name(get_yao_iowa_lessonfilehandler().belief_name)
    ohio_keg.healerunit.set_healer_name(get_yao_ohio_lessonfilehandler().belief_name)
    utah_keg.healerunit.set_healer_name(get_zia_utah_lessonfilehandler().belief_name)
