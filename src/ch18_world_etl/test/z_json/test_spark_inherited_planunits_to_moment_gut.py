...
def test_etl_spark_inherited_planunits_to_moment_gut_SetsFiles_Scenario0(
    ...
    e3_bob_plan.add_voiceunit(bob_inx, credit77)
    e3_bob_plan.add_voiceunit(yao_inx, credit44)
    e7_bob_plan.add_voiceunit(bob_inx, credit77)
    e7_bob_plan.add_voiceunit(sue_inx, credit88)
    e7_bob_plan.add_voiceunit(yao_inx, credit44)
    ...
    assert generated_gut_plan.voices == e7_bob_plan.voices
