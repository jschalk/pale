...
def test_etl_spark_lesson_json_to_spark_inherited_planunits_SetsFiles_plan_json(
    ...
    a23_bob_e3_lesson.add_p_planatom(plnptnr_dimen, kw.INSERT, bob_jkeys, bob_jvalues)
    a23_bob_e3_lesson.add_p_planatom(plnptnr_dimen, kw.INSERT, yao_jkeys, yao_jvalues)
    sue_jkeys = {kw.partner_name: sue_inx}
    sue_jvalues = {kw.partner_cred_lumen: credit88, kw.partner_debt_lumen: None}
    a23_bob_e7_lesson.add_p_planatom(plnptnr_dimen, kw.INSERT, bob_jkeys, bob_jvalues)
    a23_bob_e7_lesson.add_p_planatom(plnptnr_dimen, kw.INSERT, sue_jkeys, sue_jvalues)
    ...
    expected_e3_bob_plan.add_partnerunit(bob_inx, credit77)
    expected_e3_bob_plan.add_partnerunit(yao_inx, credit44)
    expected_e7_bob_plan.add_partnerunit(bob_inx, credit77)
    expected_e7_bob_plan.add_partnerunit(sue_inx, credit88)
    expected_e7_bob_plan.add_partnerunit(yao_inx, credit44)
    ...
    assert generated_e3_plan.partners == expected_e3_bob_plan.partners
    assert generated_e3_plan == expected_e3_bob_plan
    assert generated_e3_plan.to_dict() == expected_e3_bob_plan.to_dict()
    assert generated_e7_plan.partners == expected_e7_bob_plan.partners
...
def test_etl_spark_lesson_json_to_spark_inherited_planunits_SetsFiles_expressed_lesson(
    ...
    expected_e3_bob_lesson.add_p_planatom(
        plnptnr_dimen, kw.INSERT, bob_jkeys, bob_jvalues
    )
    expected_e3_bob_lesson.add_p_planatom(
        plnptnr_dimen, kw.INSERT, yao_jkeys, yao_jvalues
    )
    expected_e7_bob_lesson.add_p_planatom(
        plnptnr_dimen, kw.INSERT, sue_jkeys, sue_jvalues
    )
