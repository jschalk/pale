...
def test_etl_spark_lesson_json_to_spark_inherited_planunits_SetsFiles_plan_json(
    ...
    a23_bob_e3_lesson.add_p_planatom(blfvoce_dimen, kw.INSERT, bob_jkeys, bob_jvalues)
    a23_bob_e3_lesson.add_p_planatom(blfvoce_dimen, kw.INSERT, yao_jkeys, yao_jvalues)
    sue_jkeys = {kw.voice_name: sue_inx}
    sue_jvalues = {kw.voice_cred_lumen: credit88, kw.voice_debt_lumen: None}
    a23_bob_e7_lesson.add_p_planatom(blfvoce_dimen, kw.INSERT, bob_jkeys, bob_jvalues)
    a23_bob_e7_lesson.add_p_planatom(blfvoce_dimen, kw.INSERT, sue_jkeys, sue_jvalues)
