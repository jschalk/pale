...
from src.ch18_world_etl.transformers import etl_sound_vld_tables_to_heard_raw_tables
...
"""
        ...
        blrawar_h_raw_put_tablename = prime_tbl(kw.belief_voiceunit, "h", "raw", "put")
