...
"""
        ...
        print(f"{a23_e3_plnprsn_put_path=}")
        print(f"{a23_e7_plnprsn_put_path=}")
        ...
        print(f"{e3_put_csv=}")
        print(f"{e7_put_csv=}")
        expected_e3_put_csv = f"""spark_num,face_name,moment_rope,plan_name,person_name,person_cred_lumen,person_debt_lumen
3,Suzy,{exx.a23},Bobby,Bobby,5.0,
"""
        expected_e7_put_csv = f"""spark_num,face_name,moment_rope,plan_name,person_name,person_cred_lumen,person_debt_lumen
