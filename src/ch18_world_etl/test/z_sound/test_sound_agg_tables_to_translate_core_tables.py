...
def test_populate_translate_core_vld_with_missing_face_names_Scenario0_Populates1MissingTranslateCoreRow():
    ...
    with sqlite3_connect(":memory:") as db_conn:
        ...
        plnptnr_s_agg_tablename = create_prime_tablename(plnptnr_str, "s", "agg", "put")
        insert_plnptnr_sqlstr = f"""
INSERT INTO {plnptnr_s_agg_tablename} ({kw.spark_num}, {kw.face_name}, {kw.plan_name}, {kw.partner_name})
