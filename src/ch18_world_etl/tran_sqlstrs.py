...
CREATE_MMTPAYY_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_paybook_h_agg (moment_label TEXT, belief_name TEXT, voice_name TEXT, tran_time INTEGER, amount REAL)"""
...
CREATE_MMTBUDD_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_budunit_h_agg (moment_label TEXT, belief_name TEXT, bud_time INTEGER, quota REAL, celldepth INTEGER)"""
...
CREATE_MMTHOUR_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_hour_h_agg (moment_label TEXT, cumulative_minute INTEGER, hour_label TEXT)"""
...
CREATE_MMTMONT_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_month_h_agg (moment_label TEXT, cumulative_day INTEGER, month_label TEXT)"""
...
CREATE_MMTWEEK_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_epoch_weekday_h_agg (moment_label TEXT, weekday_order INTEGER, weekday_label TEXT)"""
...
CREATE_MMTOFFI_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS moment_timeoffi_h_agg (moment_label TEXT, offi_time INTEGER)"""
...
CREATE_MMTUNIT_HEARD_AGG_SQLSTR = """CREATE TABLE IF NOT EXISTS momentunit_h_agg (moment_label TEXT, epoch_label TEXT, c400_number INTEGER, yr1_jan1_offset INTEGER, monthday_index INTEGER, fund_grain REAL, mana_grain REAL, respect_grain REAL, knot TEXT, job_listen_rotations INTEGER)"""
...
CREATE_BLFMEMB_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_voice_membership_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, voice_name TEXT, group_title TEXT, group_cred_lumen REAL, group_debt_lumen REAL)"
...
CREATE_BLFMEMB_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_voice_membership_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, voice_name TEXT, group_title_ERASE TEXT)"
...
CREATE_BLFAWAR_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_awardunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, awardee_title TEXT, give_force REAL, take_force REAL)"
...
CREATE_BLFAWAR_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_awardunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, awardee_title_ERASE TEXT)"
...
CREATE_BLFFACT_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_factunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, fact_context TEXT, fact_state TEXT, fact_lower REAL, fact_upper REAL)"
...
CREATE_BLFFACT_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_factunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, fact_context_ERASE TEXT)"
...
CREATE_BLFHEAL_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_healerunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, healer_name TEXT)"
...
CREATE_BLFHEAL_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_healerunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, healer_name_ERASE TEXT)"
...
CREATE_BLFCASE_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_reason_caseunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, reason_context TEXT, reason_state TEXT, reason_upper REAL, reason_lower REAL, reason_divisor INTEGER)"
...
CREATE_BLFCASE_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_reason_caseunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, reason_context TEXT, reason_state_ERASE TEXT)"
...
CREATE_BLFREAS_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_reasonunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, reason_context TEXT, active_requisite INTEGER)"
...
CREATE_BLFREAS_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_reasonunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, reason_context_ERASE TEXT)"
...
CREATE_BLFLABO_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_partyunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, party_title TEXT, solo INTEGER)"
...
CREATE_BLFLABO_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_plan_partyunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, party_title_ERASE TEXT)"
...
CREATE_BLFPLAN_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_planunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope TEXT, begin REAL, close REAL, addin REAL, numor INTEGER, denom INTEGER, morph INTEGER, gogo_want REAL, stop_want REAL, star INTEGER, pledge INTEGER, problem_bool INTEGER)"
...
CREATE_BLFPLAN_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS belief_planunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, plan_rope_ERASE TEXT)"
...
CREATE_BLFUNIT_HEARD_PUT_AGG_STR = "CREATE TABLE IF NOT EXISTS beliefunit_h_put_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name TEXT, credor_respect REAL, debtor_respect REAL, fund_pool REAL, max_tree_traverse INTEGER, tally INTEGER, fund_grain REAL, mana_grain REAL, respect_grain REAL)"
...
CREATE_BLFUNIT_HEARD_DEL_AGG_STR = "CREATE TABLE IF NOT EXISTS beliefunit_h_del_agg (spark_num INTEGER, face_name TEXT, moment_label TEXT, belief_name_ERASE TEXT)"
...
def get_prime_create_table_sqlstrs() -> dict[str, str]:
    return {
        ...
        "belief_voice_membership_h_put_agg": CREATE_BLFMEMB_HEARD_PUT_AGG_STR,
        "belief_voice_membership_h_del_raw": CREATE_BLFMEMB_HEARD_DEL_RAW_STR,
        "belief_voice_membership_h_del_agg": CREATE_BLFMEMB_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_awardunit_h_put_agg": CREATE_BLFAWAR_HEARD_PUT_AGG_STR,
        "belief_plan_awardunit_h_del_raw": CREATE_BLFAWAR_HEARD_DEL_RAW_STR,
        "belief_plan_awardunit_h_del_agg": CREATE_BLFAWAR_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_factunit_h_put_agg": CREATE_BLFFACT_HEARD_PUT_AGG_STR,
        "belief_plan_factunit_h_del_raw": CREATE_BLFFACT_HEARD_DEL_RAW_STR,
        "belief_plan_factunit_h_del_agg": CREATE_BLFFACT_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_healerunit_h_put_agg": CREATE_BLFHEAL_HEARD_PUT_AGG_STR,
        "belief_plan_healerunit_h_del_raw": CREATE_BLFHEAL_HEARD_DEL_RAW_STR,
        "belief_plan_healerunit_h_del_agg": CREATE_BLFHEAL_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_reason_caseunit_h_put_agg": CREATE_BLFCASE_HEARD_PUT_AGG_STR,
        "belief_plan_reason_caseunit_h_del_raw": CREATE_BLFCASE_HEARD_DEL_RAW_STR,
        "belief_plan_reason_caseunit_h_del_agg": CREATE_BLFCASE_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_reasonunit_h_put_agg": CREATE_BLFREAS_HEARD_PUT_AGG_STR,
        "belief_plan_reasonunit_h_del_raw": CREATE_BLFREAS_HEARD_DEL_RAW_STR,
        "belief_plan_reasonunit_h_del_agg": CREATE_BLFREAS_HEARD_DEL_AGG_STR,
        ...
        "belief_plan_partyunit_h_put_agg": CREATE_BLFLABO_HEARD_PUT_AGG_STR,
        "belief_plan_partyunit_h_del_raw": CREATE_BLFLABO_HEARD_DEL_RAW_STR,
        "belief_plan_partyunit_h_del_agg": CREATE_BLFLABO_HEARD_DEL_AGG_STR,
        ...
        "belief_planunit_h_put_agg": CREATE_BLFPLAN_HEARD_PUT_AGG_STR,
        "belief_planunit_h_del_raw": CREATE_BLFPLAN_HEARD_DEL_RAW_STR,
        "belief_planunit_h_del_agg": CREATE_BLFPLAN_HEARD_DEL_AGG_STR,
        ...
        "beliefunit_h_put_agg": CREATE_BLFUNIT_HEARD_PUT_AGG_STR,
        "beliefunit_h_del_raw": CREATE_BLFUNIT_HEARD_DEL_RAW_STR,
        "beliefunit_h_del_agg": CREATE_BLFUNIT_HEARD_DEL_AGG_STR,
    }
...
NBUEPCH_HEARD_AGG_INSERT_SQLSTR = """
INSERT INTO nabu_epochtime_h_agg (moment_label, otx_time, inx_time)
...
INSERT_BLFMEMB_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFMEMB_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFAWAR_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFAWAR_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFFACT_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFFACT_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFHEAL_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFHEAL_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFCASE_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFCASE_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFREAS_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFREAS_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFLABO_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFLABO_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFPLAN_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFPLAN_HEARD_AGG_DEL_SQLSTR = """
...
"""
INSERT_BLFUNIT_HEARD_AGG_PUT_SQLSTR = """
...
"""
INSERT_BLFUNIT_HEARD_AGG_DEL_SQLSTR = """
...
# TODO change get_insert_heard_agg_sqlstrs moment keys
def get_insert_heard_agg_sqlstrs() -> dict[str, str]:
    return {
        "nabu_epochtime_h_agg": NBUEPCH_HEARD_AGG_INSERT_SQLSTR,
        ...
        "belief_voice_membership_h_put_agg": INSERT_BLFMEMB_HEARD_AGG_PUT_SQLSTR,
        "belief_voice_membership_h_del_agg": INSERT_BLFMEMB_HEARD_AGG_DEL_SQLSTR,
        ...
        "belief_plan_awardunit_h_put_agg": INSERT_BLFAWAR_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_awardunit_h_del_agg": INSERT_BLFAWAR_HEARD_AGG_DEL_SQLSTR,
        "belief_plan_factunit_h_put_agg": INSERT_BLFFACT_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_factunit_h_del_agg": INSERT_BLFFACT_HEARD_AGG_DEL_SQLSTR,
        "belief_plan_healerunit_h_put_agg": INSERT_BLFHEAL_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_healerunit_h_del_agg": INSERT_BLFHEAL_HEARD_AGG_DEL_SQLSTR,
        "belief_plan_reason_caseunit_h_put_agg": INSERT_BLFCASE_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_reason_caseunit_h_del_agg": INSERT_BLFCASE_HEARD_AGG_DEL_SQLSTR,
        "belief_plan_reasonunit_h_put_agg": INSERT_BLFREAS_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_reasonunit_h_del_agg": INSERT_BLFREAS_HEARD_AGG_DEL_SQLSTR,
        "belief_plan_partyunit_h_put_agg": INSERT_BLFLABO_HEARD_AGG_PUT_SQLSTR,
        "belief_plan_partyunit_h_del_agg": INSERT_BLFLABO_HEARD_AGG_DEL_SQLSTR,
        "belief_planunit_h_put_agg": INSERT_BLFPLAN_HEARD_AGG_PUT_SQLSTR,
        "belief_planunit_h_del_agg": INSERT_BLFPLAN_HEARD_AGG_DEL_SQLSTR,
        "beliefunit_h_put_agg": INSERT_BLFUNIT_HEARD_AGG_PUT_SQLSTR,
        "beliefunit_h_del_agg": INSERT_BLFUNIT_HEARD_AGG_DEL_SQLSTR,
    }


MMTPAYY_FU2_SELECT_SQLSTR = "SELECT moment_label, belief_name, voice_name, tran_time, amount FROM moment_paybook_h_agg WHERE moment_label = "
MMTBUDD_FU2_SELECT_SQLSTR = "SELECT moment_label, belief_name, bud_time, quota, celldepth FROM moment_budunit_h_agg WHERE moment_label = "
MMTHOUR_FU2_SELECT_SQLSTR = "SELECT moment_label, cumulative_minute, hour_label FROM moment_epoch_hour_h_agg WHERE moment_label = "
MMTMONT_FU2_SELECT_SQLSTR = "SELECT moment_label, cumulative_day, month_label FROM moment_epoch_month_h_agg WHERE moment_label = "
MMTWEEK_FU2_SELECT_SQLSTR = "SELECT moment_label, weekday_order, weekday_label FROM moment_epoch_weekday_h_agg WHERE moment_label = "
MMTOFFI_FU2_SELECT_SQLSTR = (
    "SELECT moment_label, offi_time FROM moment_timeoffi_h_agg WHERE moment_label = "
)
MMTUNIT_FU2_SELECT_SQLSTR = "SELECT moment_label, epoch_label, c400_number, yr1_jan1_offset, monthday_index, fund_grain, mana_grain, respect_grain, knot, job_listen_rotations FROM momentunit_h_agg WHERE moment_label = "
