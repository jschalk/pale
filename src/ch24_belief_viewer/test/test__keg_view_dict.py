...
from src.ch24_belief_viewer.belief_viewer_tool import add_small_dot, get_keg_view_dict
...
def test_get_keg_view_dict_ReturnsObj_Scenario2_RootKegUnit_attrs():
    ...
    # WHEN
    root_keg_view_dict = get_keg_view_dict(sue_beliefunit.kegroot)
...
def test_get_keg_view_dict_ReturnsObj_Scenario3_KegUnit_base_attrs():
    ...
    expected_all_voice_cred = f"all_voice_cred = {casa_keg.all_voice_cred}"
    expected_all_voice_debt = f"all_voice_debt = {casa_keg.all_voice_debt}"
...
def test_get_keg_view_dict_ReturnsObj_Scenario5_KegUnit_FactUnit():
    ...
    # WHEN
    root_dict = get_keg_view_dict(sue_belief.kegroot)
...
def test_get_keg_view_dict_ReturnsObj_Scenario6_KegUnit_ReasonUnit():
    ...
    play_soccer_keg = sue_belief.get_keg_obj(play_soccer_rope)
...
def test_get_keg_view_dict_ReturnsObj_Scenario10_active_hx():
    ...
    chicken_keg = hatter_belief.get_keg_obj(chicken_rope)
