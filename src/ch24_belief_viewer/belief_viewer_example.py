...
from src.ch07_belief_logic.belief_tool import belief_keg_reason_caseunit_set_obj
...
def get_sue_beliefunit() -> BeliefUnit:
    ...
    sue_belief.add_keg(casa_rope, 3)
    sue_belief.add_keg(tidi_rope, 7)
    sue_belief.add_keg(dirty_rope, 1)
    sue_belief.add_keg(tidy_rope, 3)
    sue_belief.add_keg(clean_rope, 3)
    sue_belief.add_keg(mop_rope, 3, pledge=True)
    sue_belief.add_keg(mop_fancy_rope, 3, pledge=True)
    sue_belief.add_keg(sweep_rope, 3, pledge=True)
    ...
    sue_belief.add_keg(sports_rope, 5)
    sue_belief.add_keg(best_soccer_rope, 23)
    sue_belief.add_keg(best_swim_rope, 2)
    sue_belief.add_keg(best_run_rope, 23)
    sue_belief.add_keg(play_rope, 2)
    sue_belief.add_keg(play_soccer_rope, 11, pledge=True)
    sue_belief.add_keg(play_swim_rope, 55, pledge=True)
    sue_belief.add_keg(play_run_rope, 22, pledge=True)
    ...
    sue_belief.edit_keg_attr(root_rope, awardunit=casa_administrator_awardunit)
    sue_belief.edit_keg_attr(root_rope, awardunit=casa_team_awardunit)
    sue_belief.edit_keg_attr(casa_rope, awardunit=casa_devloper_awardunit)
    sue_belief.edit_keg_attr(casa_rope, awardunit=casa_jundevloper_awardunit)
    sue_belief.cashout()
    return sue_belief
...
def get_sue_belief_with_facts_and_reasons() -> BeliefUnit:
    ...
    sue_belief.edit_keg_attr(mop_rope, laborunit=mop_laborunit)
    ...
    belief_keg_reason_caseunit_set_obj(sue_belief, tidi_dirty_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, swwep_dirty_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, soccer_soccer_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, soccer_run_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, soccer_tidy_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, swim_swim_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, swim_tidy_jkeys)
    belief_keg_reason_caseunit_set_obj(sue_belief, run_run_jkeys)
    sue_belief.cashout()
    return sue_belief
