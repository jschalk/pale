...
from src.ch07_belief_logic.belief_main import BeliefUnit, get_sorted_keg_list
...
def create_gcalendar_events_list(x_belief: BeliefUnit, day: datetime) -> list[dict]:
    agenda_kegs_dict = x_belief.get_agenda_dict()
