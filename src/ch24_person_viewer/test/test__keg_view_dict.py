...
from src.ch24_person_viewer.person_viewer_tool import add_small_dot, get_keg_view_dict
...
def test_get_keg_view_dict_ReturnsObj_Scenario2_RootKegUnit_attrs():
    ...
    # WHEN
    root_keg_view_dict = get_keg_view_dict(sue_personunit.kegroot)
...
def test_get_keg_view_dict_ReturnsObj_Scenario5_KegUnit_FactUnit():
    ...
    # WHEN
    root_dict = get_keg_view_dict(sue_person.kegroot)
...
def test_get_keg_view_dict_ReturnsObj_Scenario6_KegUnit_ReasonUnit():
    ...
    play_soccer_keg = sue_person.get_keg_obj(play_soccer_rope)
...
def test_get_keg_view_dict_ReturnsObj_Scenario10_active_hx():
    ...
    chicken_keg = hatter_person.get_keg_obj(chicken_rope)
