...
from src.ch01_py.chapter_desc_main import get_chapter_descs, valid_chapter_numbers
from unittest.mock import patch


def test_get_chapter_descs_Scenario0_RemovesLinterAndRef():
    # ESTABLISH
    with patch("src.ch01_py.chapter_desc_main.get_level1_dirs") as mock_get_dirs, patch(
        "src.ch01_py.chapter_desc_main.create_path"
    ) as mock_create_path:
...
def test_get_chapter_descs_Scenario2_RaisesErrorIf_linterIsMissing():
    ...
    """
    # ESTABLISH / WHEN / THEN
    with patch("src.ch01_py.chapter_desc_main.get_level1_dirs") as mock_get_dirs:
