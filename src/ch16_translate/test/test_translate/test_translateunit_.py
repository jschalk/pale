...
def test_get_translate_args_class_types_ReturnsObj():
    ...
    assert translate_args_class_types.get(kw.fact_upper) == kw.CotoNum
    assert translate_args_class_types.get(kw.fact_lower) == kw.CotoNum
    ...
    assert translate_args_class_types.get(kw.reason_upper) == kw.CotoNum
    ...
    assert translate_args_class_types.get(kw.reason_lower) == kw.CotoNum
