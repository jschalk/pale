...
def get_idea_format_headers() -> dict[str, list[str]]:
    return {
        ...
        "person_name,plan_rope,awardee_title,give_force,take_force": idea_format_00022_person_plan_awardunit_v0_0_0(),
        "person_name,plan_rope,fact_context,fact_state,fact_lower,fact_upper": idea_format_00023_person_plan_factunit_v0_0_0(),
        "person_name,plan_rope,party_title,solo": idea_format_00024_person_plan_partyunit_v0_0_0(),
        "person_name,plan_rope,healer_name": idea_format_00025_person_plan_healerunit_v0_0_0(),
        "person_name,plan_rope,reason_context,reason_state,reason_lower,reason_upper,reason_divisor": idea_format_00026_person_plan_reason_caseunit_v0_0_0(),
        "person_name,plan_rope,reason_context,active_requisite": idea_format_00027_person_plan_reasonunit_v0_0_0(),
        "person_name,plan_rope,begin,close,addin,numor,denom,morph,gogo_want,stop_want,star,pledge,problem_bool": idea_format_00028_person_planunit_v0_0_0(),
