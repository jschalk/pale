...
def test_create_init_stance_idea_csv_strs_ReturnsObj_Scenario0_EmptyMomentUnit(
    ...
    expected_stance_csv_strs = {
        ...
        "br00022": "moment_rope,person_name,keg_rope,awardee_title,give_force,take_force\n",
        "br00023": "moment_rope,person_name,keg_rope,fact_context,fact_state,fact_lower,fact_upper\n",
        "br00024": "moment_rope,person_name,keg_rope,party_title,solo\n",
        "br00025": "moment_rope,person_name,keg_rope,healer_name\n",
        "br00026": "moment_rope,person_name,keg_rope,reason_context,reason_state,reason_lower,reason_upper,reason_divisor\n",
        "br00027": "moment_rope,person_name,keg_rope,reason_context,active_requisite\n",
        "br00028": "moment_rope,person_name,keg_rope,begin,close,addin,numor,denom,morph,gogo_want,stop_want,star,pledge,problem_bool\n",
...
def test_add_person_to_br00022_csv_ReturnsObj():
    ...
    bob_person.add_keg(casa_rope)
    bob_person.edit_keg_attr(casa_rope, awardunit=casa_awardunit)
...
def test_add_personunit_to_stance_csv_strs_ReturnsObj():
    ...
    bob_person.add_keg(casa_rope)
    bob_person.add_keg(clean_rope)
    bob_person.edit_keg_attr(mop_rope, reason_context=casa_rope, reason_case=clean_rope)
    bob_person.add_keg(casa_rope)
    bob_person.edit_keg_attr(casa_rope, awardunit=awardunit_shop(exx.yao))
