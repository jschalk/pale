...
def test_create_idea_df_Arg_idea_format_00021_plan_partnerunit_v0_0_0():
    # ESTABLISH
    ...
    assert partner_dataframe.loc[0, kw.plan_name] == sue_planunit.plan_name
    ...
    assert partner_dataframe.loc[1, kw.plan_name] == sue_planunit.plan_name
    ...
    assert partner_dataframe.loc[2, kw.plan_name] == sue_planunit.plan_name
...
def test_create_idea_df_Arg_idea_format_00020_plan_partner_membership_v0_0_0():
    # ESTABLISH
    amy_moment_rope = create_rope("amy56")
    sue_planunit = planunit_shop(exx.sue, amy_moment_rope)
...
def test_save_idea_csv_Arg_idea_format_00021_plan_partnerunit_v0_0_0_SaveToCSV(
    temp_dir_setup,
):
    # ESTABLISH
    sue_partner_cred_lumen = 11
    ...
    j1_ideaname = idea_format_00021_plan_partnerunit_v0_0_0()
    ...
    sue1_name_example_csv = """spark_num,face_name,moment_rope,plan_name,partner_name,partner_cred_lumen,partner_debt_lumen
,,;amy56;,Sue,Bob,13,29
,,;amy56;,Sue,Sue,11,23
,,;amy56;,Sue,Yao,41,37
"""
    ...
    # WHEN
    sue_planunit.add_partnerunit(exx.zia)
    save_idea_csv(j1_ideaname, sue_planunit, idea_moments_dir(), name_filename)

    # THEN
    assert os_path_exists(csv_example_path)
    sue2_partner_example_csv = """spark_num,face_name,moment_rope,plan_name,partner_name,partner_cred_lumen,partner_debt_lumen
,,;amy56;,Sue,Bob,13,29
,,;amy56;,Sue,Sue,11,23
,,;amy56;,Sue,Yao,41,37
,,;amy56;,Sue,Zia,1,1
