...
def test_get_idea_config_dict_ReturnsObj_Scenario0_IsFullyPopulated():
    ...
    assert kw.person_keg_awardunit in idea_config_dimens
    assert kw.person_keg_factunit in idea_config_dimens
    assert kw.person_keg_partyunit in idea_config_dimens
    assert kw.person_keg_healerunit in idea_config_dimens
    assert kw.person_keg_reason_caseunit in idea_config_dimens
    assert kw.person_keg_reasonunit in idea_config_dimens
    assert kw.person_kegunit in idea_config_dimens
...
def _validate_idea_format_files(idea_filenames: set[str]):
    ...
    for idea_filename in idea_filenames:
        ...
        for x_dimen, dimen_keys in all_dimen_keys_dict.items():
            # if x_dimen == kw.person_keg_factunit and x_dimen in format_dimens:
...
def test_get_idea_config_dict_ReturnsObj_Scenario1_Check_build_order():
    ...
    # set_idea_config_json(kw.person_keg_awardunit, 11)
    # set_idea_config_json(kw.person_keg_factunit, 12)
    # set_idea_config_json(kw.person_keg_partyunit, 14)
    # set_idea_config_json(kw.person_keg_healerunit, 15)
    # set_idea_config_json(kw.person_keg_reason_caseunit, 16)
    # set_idea_config_json(kw.person_keg_reasonunit, 17)
    # set_idea_config_json(kw.person_kegunit, 18)
    ...
    assert x_idea_config.get(kw.person_keg_awardunit).get(bo) == 11
    assert x_idea_config.get(kw.person_keg_factunit).get(bo) == 12
    assert x_idea_config.get(kw.person_keg_partyunit).get(bo) == 14
    assert x_idea_config.get(kw.person_keg_healerunit).get(bo) == 15
    assert x_idea_config.get(kw.person_keg_reason_caseunit).get(bo) == 16
    assert x_idea_config.get(kw.person_keg_reasonunit).get(bo) == 17
    assert x_idea_config.get(kw.person_kegunit).get(bo) == 18
...
def test_get_idea_config_dict_ReturnsObj_Scenario0_Person():
    ...
    assert person_idea_config.get(kw.person_keg_awardunit)
    assert person_idea_config.get(kw.person_keg_factunit)
    assert person_idea_config.get(kw.person_keg_partyunit)
    assert person_idea_config.get(kw.person_keg_healerunit)
    assert person_idea_config.get(kw.person_keg_reason_caseunit)
    assert person_idea_config.get(kw.person_keg_reasonunit)
    assert person_idea_config.get(kw.person_kegunit)
