...
def test_PlanUnit_cashout_ClearsDescendantAttributes():
    ...
    assert sue_plan.kegroot.all_voice_cred is None
    assert sue_plan.kegroot.all_voice_debt is None
    ...
    sue_plan.kegroot.all_voice_cred = -2
    sue_plan.kegroot.all_voice_debt = -2
    ...
    assert sue_plan.kegroot.all_voice_cred == -2
    assert sue_plan.kegroot.all_voice_debt == -2
    ...
    assert sue_plan.kegroot.all_voice_cred is True
    assert sue_plan.kegroot.all_voice_debt is True
...
def test_PlanUnit_cashout_RootOnlySetsDescendantAttributes():
    ...
    assert yao_plan.kegroot.all_voice_cred is None
    assert yao_plan.kegroot.all_voice_debt is None
    ...
    assert yao_plan.kegroot.all_voice_cred is True
    assert yao_plan.kegroot.all_voice_debt is True
...
def test_PlanUnit_cashout_NLevelSetsDescendantAttributes_2():
    ...
    # THEN
    assert sue_plan.kegroot.all_voice_cred is False
    assert sue_plan.kegroot.all_voice_debt is False
...
def test_PlanUnit_cashout_CreatesNewGroupUnits_Scenario0():
    ...
    yao_plan.add_voiceunit(exx.yao, yao_voice_cred_lumen, yao_voice_debt_lumen)
    ...
    assert len(yao_plan.get_voiceunit_group_titles_dict()) == 2
    ...
    assert len(yao_plan.get_voiceunit_group_titles_dict()) == 2
    assert len(yao_plan.get_voiceunit_group_titles_dict()) != len(yao_plan.groupunits)
