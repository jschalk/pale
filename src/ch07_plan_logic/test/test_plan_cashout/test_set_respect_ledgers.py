...
def test_PlanUnit_set_voiceunit_groupunit_respect_ledgers_SetsAttr_Scenario0():
    # ESTABLISH
    sue_planunit = planunit_shop(exx.sue)
    assert sue_planunit.groupunits == {}

    # WHEN
    sue_planunit._set_voiceunit_groupunit_respect_ledgers()

    # THEN
    assert sue_planunit.groupunits == {}


def test_PlanUnit_set_voiceunit_groupunit_respect_ledgers_Clears_groupunits():
    # ESTABLISH
    sue_planunit = planunit_shop(exx.sue)
...
def test_PlanUnit_set_voiceunit_groupunit_respect_ledgers_SetsAttr_Scenario1():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_planunit = planunit_shop(exx.sue)
    sue_planunit.add_voiceunit(exx.yao)
    ...
    assert yao_voiceunit.credor_pool != 0
    assert yao_voiceunit.debtor_pool != 0
    assert yao_voiceunit.credor_pool == sue_planunit.credor_respect
    assert yao_voiceunit.debtor_pool == sue_planunit.debtor_respect
...
def test_PlanUnit_set_voiceunit_groupunit_respect_ledgers_SetsAttr_Scenario2():
    # ESTABLISH
    sue_planunit = planunit_shop(exx.sue)
    sue_planunit.add_voiceunit(exx.yao)
    yao_voiceunit = sue_planunit.get_voice(exx.yao)
    ...
    # THEN
    assert sue_planunit.get_voice(exx.yao).credor_pool != 0
    assert sue_planunit.get_voice(exx.yao).debtor_pool != 0
    assert yao_voiceunit.get_membership(exx.yao).credor_pool != 0
    assert yao_voiceunit.get_membership(exx.yao).debtor_pool != 0
    yao_yao_membership = yao_voiceunit.get_membership(exx.yao)
...
def test_PlanUnit_set_voiceunit_groupunit_respect_ledgers_ResetVoiceUnitsAttrs():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_planunit = planunit_shop(exx.sue)
    sue_planunit.add_voiceunit(exx.yao, 55, 55)
    sue_planunit.add_voiceunit(exx.zia, 55, 55)
    yao_voiceunit = sue_planunit.get_voice(exx.yao)
    zia_voiceunit = sue_planunit.get_voice(exx.zia)
