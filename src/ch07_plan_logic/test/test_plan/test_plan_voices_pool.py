...
def test_PlanUnit_set_voice_respect_SetsAttrs():
    # ESTABLISH
    ...
    # WHEN
    new_voice_pool = 200
    zia_plan.set_voice_respect(new_voice_pool)

    # THEN
    assert zia_plan.credor_respect == new_voice_pool
    assert zia_plan.debtor_respect == new_voice_pool
    assert zia_plan.fund_pool == new_voice_pool
