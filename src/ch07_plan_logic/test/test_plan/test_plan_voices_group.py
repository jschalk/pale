...
def test_PlanUnit_get_voiceunit_group_titles_dict_ReturnsObj():
    # ESTABLISH
    bob_plan = planunit_shop(exx.bob)
    bob_plan.add_voiceunit(exx.yao)
    bob_plan.add_voiceunit(exx.sue)
    bob_plan.add_voiceunit(exx.zia)
    sue_voiceunit = bob_plan.get_voice(exx.sue)
    ...
    # WHEN
    group_titles_dict = bob_plan.get_voiceunit_group_titles_dict()
...
def test_PlanUnit_create_symmetry_groupunit_ReturnsObj():
    ...
    yao_plan.add_voiceunit(exx.yao, yao_group_cred_lumen, yao_group_debt_lumen)
    yao_plan.add_voiceunit(exx.zia, zia_group_cred_lumen, zia_group_debt_lumen)
