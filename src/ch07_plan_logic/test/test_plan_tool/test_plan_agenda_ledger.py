...
from src.ch07_plan_logic.plan_tool import (
    ...
    get_plan_partner_agenda_award_array,
    get_plan_partner_agenda_award_csv,
)
from src.ref.keywords import ExampleStrs as exx


def test_get_plan_partner_agenda_award_array_ReturnsObj_ScenarioZeroPartnerUnits():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")

    # WHEN / THEN
    assert get_plan_partner_agenda_award_array(sue_plan) == []


def test_get_plan_partner_agenda_award_array_ReturnsObj_ScenarioSinglePartnerUnit():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    sue_plan.add_partnerunit(exx.yao)

    # WHEN / THEN
    assert len(get_plan_partner_agenda_award_array(sue_plan)) == 1


def test_get_plan_partner_agenda_award_array_ReturnsObj_ScenarioMultiplePartnerUnit():
    # ESTABLISH
    ...
    sue_plan.get_partner(exx.yao).fund_agenda_give = yao_fund_agenda_give
    sue_plan.get_partner(exx.yao).fund_agenda_take = yao_fund_agenda_take
    sue_plan.get_partner(exx.bob).fund_agenda_give = bob_fund_agenda_give
    sue_plan.get_partner(exx.bob).fund_agenda_take = bob_fund_agenda_take

    # WHEN
    plan_partner_agenda_award_array = get_plan_partner_agenda_award_array(sue_plan)

    # THEN
    assert len(plan_partner_agenda_award_array) == 3
    assert plan_partner_agenda_award_array[0][0] == exx.bob
    assert plan_partner_agenda_award_array[1][0] == exx.yao
    assert plan_partner_agenda_award_array[2][0] == exx.zia
    assert len(plan_partner_agenda_award_array[0]) == 3
    assert len(plan_partner_agenda_award_array[1]) == 3
    assert len(plan_partner_agenda_award_array[2]) == 3
    assert plan_partner_agenda_award_array[0][1] == bob_fund_agenda_take
    assert plan_partner_agenda_award_array[0][2] == bob_fund_agenda_give
    assert plan_partner_agenda_award_array[1][1] == yao_fund_agenda_take
    assert plan_partner_agenda_award_array[1][2] == yao_fund_agenda_give


def test_get_plan_partner_agenda_award_csv_ReturnsObj_ScenarioMultiplePartnerUnit():
    # ESTABLISH
    yao_fund_agenda_give = 17
    yao_fund_agenda_take = 23
    bob_fund_agenda_give = 17
    ...
    # WHEN
    plan_partner_agenda_award_csv_str = get_plan_partner_agenda_award_csv(sue_plan)

    # THEN
    print(f"{plan_partner_agenda_award_csv_str=}")
    print("")
...
"""
    ...
    assert plan_partner_agenda_award_csv_str == example_csv_str


def test_get_plan_partner_agenda_award_csv_ReturnsObj_cashout_True():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    sue_plan.add_partnerunit(exx.yao)
    sue_plan.add_partnerunit(exx.bob)
    sue_plan.add_partnerunit(exx.xio)
    sue_plan.add_partnerunit(exx.zia)
...
{exx.zia},0,0
"""
    assert empty_partner_agenda_award == get_plan_partner_agenda_award_csv(sue_plan)

    # WHEN
    plan_partner_agenda_award_csv_str = get_plan_partner_agenda_award_csv(
...
def test_get_partner_mandate_ledger_ReturnsObj_Scenario0_MultiplePartnerUnit():
    ...
    # WHEN
    plan_bud_net_dict = get_partner_mandate_ledger(sue_plan)
...
def test_get_partner_mandate_ledger_ReturnsObj_Scenario1_cashout_True():
    # ESTABLISH
    sue_plan = planunit_shop("Sue")
    sue_plan.add_partnerunit(exx.yao, 13, 5)
    sue_plan.add_partnerunit(exx.bob, 5, 7)
    sue_plan.add_partnerunit(exx.xio, 2, 3)
    sue_plan.add_partnerunit(exx.zia, 0, 0)
    ...
    assert get_partner_mandate_ledger(sue_plan) == pre_settle_partner_mandate_ledger

    # WHEN
    sue_plan_settle_net_dict = get_partner_mandate_ledger(sue_plan, cashout=True)

    # THEN
    assert sue_plan_settle_net_dict != pre_settle_partner_mandate_ledger
...
def test_get_partner_mandate_ledger_ReturnsObj_Scenario2_No_partnerunits():
    ...
    empty_partner_mandate_ledger = {exx.sue: sue_plan.fund_pool}

    # WHEN / THEN
    assert get_partner_mandate_ledger(sue_plan) == empty_partner_mandate_ledger


def test_get_partner_mandate_ledger_ReturnsObj_Scenario3_No_planunit():
    # ESTABLISH / WHEN / THEN
...
def test_get_partner_agenda_net_ledger_ReturnsObj_ScenarioMultiplePartnerUnit():
    ...
    # WHEN
    plan_bud_net_dict = get_partner_agenda_net_ledger(sue_plan)
...
def test_get_partner_agenda_net_ledger_ReturnsObj_cashout_True():
    ...
    sue_plan.add_partnerunit(exx.xio, 2, 3)
    sue_plan.add_partnerunit(exx.zia, 0, 0)
    assert get_partner_agenda_net_ledger(sue_plan) == {}

    # WHEN
    sue_plan_settle_net_dict = get_partner_agenda_net_ledger(sue_plan, cashout=True)
...
def test_get_credit_ledger_ReturnsObj_Scenario1_partnerunits_Exist():
    ...
    sue_plan.add_partnerunit(exx.yao, yao_partner_cred_lumen)
    sue_plan.add_partnerunit(exx.bob, bob_partner_cred_lumen)
    sue_plan.add_partnerunit(exx.xio, xio_partner_cred_lumen)
