from src.ch07_belief_logic.belief_main import beliefunit_shop, get_sorted_keg_list
...
def test_set_epoch_base_case_dayly_SetsAttr_Scenario0_NoWarppingParameters():
    ...
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_dayly_args)
...
def test_set_epoch_base_case_dayly_SetsAttr_Scenario1_WarppingParameters():
    ...
    mop_day_duration = 95
    assert bob_belief.keg_exists(wx.day_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_dayly_args)
    ...
    assert day_case.reason_divisor == 1440
    # for x_keg in get_sorted_keg_list(bob_belief._keg_dict):
...
def test_set_epoch_base_case_xdays_SetsAttr_Scenario0_NoWarppingParameters():
    ...
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_xdays_args)
    bob_belief.cashout()
    for x_keg in get_sorted_keg_list(bob_belief._keg_dict):
        print(f"{x_keg.get_keg_rope()=}")
    ...
    xdays_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_xdays_args)
...
def test_set_epoch_base_case_weekly_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_weekly_args)
    ...
    day_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_weekly_args)
...
def test_set_epoch_base_case_xweeks_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    mop_week_upper = 5
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_xweeks_args)
...
def test_set_epoch_base_case_range_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_range_args)
    ...
    day_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_range_args)
    ...
    assert day_case.reason_divisor == bob_belief.get_keg_obj(wx.five_rope).close
...
def test_set_epoch_base_case_monthday_SetsAttr_Scenario0_NoWrapingParameters():
    ...
    #     print(f"{x_keg.get_keg_rope()=}")
    assert bob_belief.keg_exists(wx.five_rope)
    assert not belief_keg_reason_caseunit_exists(bob_belief, mop_monthday_args)
    ...
    day_case = belief_keg_reason_caseunit_get_obj(bob_belief, mop_monthday_args)
    assert day_case.reason_state == month_geo_rope
    month_geo_keg = bob_belief.get_keg_obj(month_geo_rope)
...
def test_set_epoch_base_case_monthday_SetsAttr_Scenario1_WrapingParameters():
    ...
    month_trump_keg = bob_belief.get_keg_obj(month_trump_rope)
...
def test_set_epoch_base_case_monthly_SetsAttr_Scenario0_AllDays_within_month_range():
    ...
    assert not belief_keg_reasonunit_exists(bob_belief, mop_year_args)
    ...
    # THEN
    assert belief_keg_reasonunit_exists(bob_belief, mop_year_args)
    year_reasonunit = belief_keg_reasonunit_get_obj(bob_belief, mop_year_args)
...
def test_del_epoch_reason_SetsAttr_Scenario0_NoReasonUnitExists():
    ...
    bob_belief.add_keg(wx.mop_rope)
    mop_dayly_args = {
        kw.keg_rope: wx.mop_rope,
        kw.reason_context: wx.day_rope,
        kw.reason_state: wx.day_rope,
    }
    assert bob_belief.keg_exists(wx.mop_rope)
    assert not belief_keg_reasonunit_exists(bob_belief, mop_dayly_args)
...
def test_del_epoch_reason_SetsAttr_Scenario1_ReasonUnitExists():
    ...
    assert belief_keg_reasonunit_exists(bob_belief, mop_dayly_args)
