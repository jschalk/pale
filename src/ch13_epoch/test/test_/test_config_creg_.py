...
def test_add_time_creg_kegunit_ReturnsObjWith_days():
    ...
    print(f"{creg_rope=}")
    print(f"{day_rope=}")
    assert not sue_beliefunit.keg_exists(time_rope)
    assert not sue_beliefunit.keg_exists(creg_rope)
    assert not sue_beliefunit.keg_exists(day_rope)
    assert not sue_beliefunit.keg_exists(days_rope)
    ...
    assert sue_beliefunit.get_keg_obj(creg_rope).begin == 0
    assert sue_beliefunit.get_keg_obj(creg_rope).close == 1472657760
    assert sue_beliefunit.get_keg_obj(day_rope).denom == 1440
    assert sue_beliefunit.get_keg_obj(day_rope).morph
    assert sue_beliefunit.get_keg_obj(days_rope).denom == 1440
    assert sue_beliefunit.get_keg_obj(days_rope).morph is None
...
def test_add_time_creg_kegunit_ReturnsObjWith_weeks():
    ...
    assert not sue_beliefunit.keg_exists(week_rope)
    assert not sue_beliefunit.keg_exists(sun_rope)
    assert not sue_beliefunit.keg_exists(mon_rope)
    assert not sue_beliefunit.keg_exists(tue_rope)
    assert not sue_beliefunit.keg_exists(wed_rope)
    assert not sue_beliefunit.keg_exists(thu_rope)
    assert not sue_beliefunit.keg_exists(fri_rope)
    assert not sue_beliefunit.keg_exists(sat_rope)
    assert not sue_beliefunit.keg_exists(weeks_rope)
    ...
    assert sue_beliefunit.get_keg_obj(week_rope).gogo_want is None
    assert sue_beliefunit.get_keg_obj(week_rope).stop_want is None
    assert sue_beliefunit.get_keg_obj(week_rope).denom == 10080
    assert sue_beliefunit.get_keg_obj(week_rope).morph
    ...
    assert sue_beliefunit.get_keg_obj(weeks_rope).denom == 10080
    assert sue_beliefunit.get_keg_obj(weeks_rope).morph is None
...
def test_add_time_creg_kegunit_ReturnsObjWith_c400_leap_rope():
    ...
    assert not sue_beliefunit.keg_exists(c400_leap_rope)
    ...
    assert sue_beliefunit.keg_exists(c400_clean_rope)
    c400_clean_keg = sue_beliefunit.get_keg_obj(c400_clean_rope)
    ...
    assert sue_beliefunit.keg_exists(c100_rope)
    c100_keg = sue_beliefunit.get_keg_obj(c100_rope)
    assert not c100_keg.gogo_want
    assert not c100_keg.stop_want
    assert c100_keg.denom == 52594560
    assert c100_keg.morph

    assert sue_beliefunit.keg_exists(yr4_leap_rope)
    yr4_leap_keg = sue_beliefunit.get_keg_obj(yr4_leap_rope)
    ...
    assert sue_beliefunit.keg_exists(yr4_clean_rope)
    yr4_clean_keg = sue_beliefunit.get_keg_obj(yr4_clean_rope)
...
def test_add_time_creg_kegunit_ReturnsObjWith_years():
    ...
    assert not sue_beliefunit.keg_exists(creg_rope)
    assert not sue_beliefunit.keg_exists(year_rope)
    ...
    assert not sue_beliefunit.keg_exists(jan_rope)
    assert not sue_beliefunit.keg_exists(feb_rope)
    assert not sue_beliefunit.keg_exists(mar_rope)
    assert not sue_beliefunit.keg_exists(apr_rope)
    assert not sue_beliefunit.keg_exists(may_rope)
    assert not sue_beliefunit.keg_exists(jun_rope)
    assert not sue_beliefunit.keg_exists(jul_rope)
    assert not sue_beliefunit.keg_exists(aug_rope)
    assert not sue_beliefunit.keg_exists(sep_rope)
    assert not sue_beliefunit.keg_exists(oct_rope)
    assert not sue_beliefunit.keg_exists(nov_rope)
    assert not sue_beliefunit.keg_exists(dec_rope)
    assert not sue_beliefunit.keg_exists(year_rope)
    ...
    year_keg = sue_beliefunit.get_keg_obj(year_rope)
    # assert year_keg.morph
    assert sue_beliefunit.keg_exists(jan_rope)
    assert sue_beliefunit.keg_exists(feb_rope)
    assert sue_beliefunit.keg_exists(mar_rope)
    assert sue_beliefunit.keg_exists(apr_rope)
    assert sue_beliefunit.keg_exists(may_rope)
    assert sue_beliefunit.keg_exists(jun_rope)
    assert sue_beliefunit.keg_exists(jul_rope)
    assert sue_beliefunit.keg_exists(aug_rope)
    assert sue_beliefunit.keg_exists(sep_rope)
    assert sue_beliefunit.keg_exists(oct_rope)
    assert sue_beliefunit.keg_exists(nov_rope)
    assert sue_beliefunit.keg_exists(dec_rope)
    assert sue_beliefunit.get_keg_obj(jan_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(feb_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(mar_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(apr_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(may_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(jun_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(jul_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(aug_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(sep_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(oct_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(nov_rope).addin == 1440
    assert sue_beliefunit.get_keg_obj(dec_rope).addin == 1440

    assert sue_beliefunit.get_keg_obj(jan_rope).gogo_want == 440640
    assert sue_beliefunit.get_keg_obj(feb_rope).gogo_want == 485280
    assert sue_beliefunit.get_keg_obj(mar_rope).gogo_want == 0
    assert sue_beliefunit.get_keg_obj(apr_rope).gogo_want == 44640
    assert sue_beliefunit.get_keg_obj(may_rope).gogo_want == 87840
    assert sue_beliefunit.get_keg_obj(jun_rope).gogo_want == 132480
    assert sue_beliefunit.get_keg_obj(jul_rope).gogo_want == 175680
    assert sue_beliefunit.get_keg_obj(aug_rope).gogo_want == 220320
    assert sue_beliefunit.get_keg_obj(sep_rope).gogo_want == 264960
    assert sue_beliefunit.get_keg_obj(oct_rope).gogo_want == 308160
    assert sue_beliefunit.get_keg_obj(nov_rope).gogo_want == 352800
    assert sue_beliefunit.get_keg_obj(dec_rope).gogo_want == 396000

    assert sue_beliefunit.get_keg_obj(jan_rope).stop_want == 485280
    assert sue_beliefunit.get_keg_obj(feb_rope).stop_want == 525600
    assert sue_beliefunit.get_keg_obj(mar_rope).stop_want == 44640
    assert sue_beliefunit.get_keg_obj(apr_rope).stop_want == 87840
    assert sue_beliefunit.get_keg_obj(may_rope).stop_want == 132480
    assert sue_beliefunit.get_keg_obj(jun_rope).stop_want == 175680
    assert sue_beliefunit.get_keg_obj(jul_rope).stop_want == 220320
    assert sue_beliefunit.get_keg_obj(aug_rope).stop_want == 264960
    assert sue_beliefunit.get_keg_obj(sep_rope).stop_want == 308160
    assert sue_beliefunit.get_keg_obj(oct_rope).stop_want == 352800
    assert sue_beliefunit.get_keg_obj(nov_rope).stop_want == 396000
    assert sue_beliefunit.get_keg_obj(dec_rope).stop_want == 440640
...
def test_add_time_creg_kegunit_ReturnsObjWith_hours():
    ...
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
    day_rope = sue_beliefunit.make_rope(creg_rope, kw.day)
    hour_rope = sue_beliefunit.make_rope(day_rope, kw.hour)
    ...
    assert not sue_beliefunit.keg_exists(creg_rope)
    assert not sue_beliefunit.keg_exists(day_rope)
    assert not sue_beliefunit.keg_exists(hr_00_rope)
    assert not sue_beliefunit.keg_exists(hr_01_rope)
    assert not sue_beliefunit.keg_exists(hr_02_rope)
    assert not sue_beliefunit.keg_exists(hr_03_rope)
    assert not sue_beliefunit.keg_exists(hr_04_rope)
    assert not sue_beliefunit.keg_exists(hr_05_rope)
    assert not sue_beliefunit.keg_exists(hr_06_rope)
    assert not sue_beliefunit.keg_exists(hr_07_rope)
    assert not sue_beliefunit.keg_exists(hr_08_rope)
    assert not sue_beliefunit.keg_exists(hr_09_rope)
    assert not sue_beliefunit.keg_exists(hr_10_rope)
    assert not sue_beliefunit.keg_exists(hr_11_rope)
    assert not sue_beliefunit.keg_exists(hr_12_rope)
    assert not sue_beliefunit.keg_exists(hr_13_rope)
    assert not sue_beliefunit.keg_exists(hr_14_rope)
    assert not sue_beliefunit.keg_exists(hr_15_rope)
    assert not sue_beliefunit.keg_exists(hr_16_rope)
    assert not sue_beliefunit.keg_exists(hr_17_rope)
    assert not sue_beliefunit.keg_exists(hr_18_rope)
    assert not sue_beliefunit.keg_exists(hr_19_rope)
    assert not sue_beliefunit.keg_exists(hr_20_rope)
    assert not sue_beliefunit.keg_exists(hr_21_rope)
    assert not sue_beliefunit.keg_exists(hr_22_rope)
    assert not sue_beliefunit.keg_exists(hr_23_rope)
    ...
    assert sue_beliefunit.keg_exists(creg_rope)
    assert sue_beliefunit.keg_exists(day_rope)
    # assert sue_beliefunit.get_keg_obj(hour_rope).denom == 60
    # assert sue_beliefunit.get_keg_obj(hour_rope).morph
    # assert not sue_beliefunit.get_keg_obj(hour_rope).gogo_want
    # assert not sue_beliefunit.get_keg_obj(hour_rope).stop_want
    assert sue_beliefunit.keg_exists(hr_00_rope)
    assert sue_beliefunit.keg_exists(hr_01_rope)
    assert sue_beliefunit.keg_exists(hr_02_rope)
    assert sue_beliefunit.keg_exists(hr_03_rope)
    assert sue_beliefunit.keg_exists(hr_04_rope)
    assert sue_beliefunit.keg_exists(hr_05_rope)
    assert sue_beliefunit.keg_exists(hr_06_rope)
    assert sue_beliefunit.keg_exists(hr_07_rope)
    assert sue_beliefunit.keg_exists(hr_08_rope)
    assert sue_beliefunit.keg_exists(hr_09_rope)
    assert sue_beliefunit.keg_exists(hr_10_rope)
    assert sue_beliefunit.keg_exists(hr_11_rope)
    assert sue_beliefunit.keg_exists(hr_12_rope)
    assert sue_beliefunit.keg_exists(hr_13_rope)
    assert sue_beliefunit.keg_exists(hr_14_rope)
    assert sue_beliefunit.keg_exists(hr_15_rope)
    assert sue_beliefunit.keg_exists(hr_16_rope)
    assert sue_beliefunit.keg_exists(hr_17_rope)
    assert sue_beliefunit.keg_exists(hr_18_rope)
    assert sue_beliefunit.keg_exists(hr_19_rope)
    assert sue_beliefunit.keg_exists(hr_20_rope)
    assert sue_beliefunit.keg_exists(hr_21_rope)
    assert sue_beliefunit.keg_exists(hr_22_rope)
    assert sue_beliefunit.keg_exists(hr_23_rope)
    assert sue_beliefunit.get_keg_obj(hr_00_rope).gogo_want == 0
    assert sue_beliefunit.get_keg_obj(hr_01_rope).gogo_want == 60
    assert sue_beliefunit.get_keg_obj(hr_02_rope).gogo_want == 120
    assert sue_beliefunit.get_keg_obj(hr_03_rope).gogo_want == 180
    assert sue_beliefunit.get_keg_obj(hr_04_rope).gogo_want == 240
    assert sue_beliefunit.get_keg_obj(hr_05_rope).gogo_want == 300
    assert sue_beliefunit.get_keg_obj(hr_06_rope).gogo_want == 360
    assert sue_beliefunit.get_keg_obj(hr_07_rope).gogo_want == 420
    assert sue_beliefunit.get_keg_obj(hr_08_rope).gogo_want == 480
    assert sue_beliefunit.get_keg_obj(hr_09_rope).gogo_want == 540
    assert sue_beliefunit.get_keg_obj(hr_10_rope).gogo_want == 600
    assert sue_beliefunit.get_keg_obj(hr_11_rope).gogo_want == 660
    assert sue_beliefunit.get_keg_obj(hr_12_rope).gogo_want == 720
    assert sue_beliefunit.get_keg_obj(hr_13_rope).gogo_want == 780
    assert sue_beliefunit.get_keg_obj(hr_14_rope).gogo_want == 840
    assert sue_beliefunit.get_keg_obj(hr_15_rope).gogo_want == 900
    assert sue_beliefunit.get_keg_obj(hr_16_rope).gogo_want == 960
    assert sue_beliefunit.get_keg_obj(hr_17_rope).gogo_want == 1020
    assert sue_beliefunit.get_keg_obj(hr_18_rope).gogo_want == 1080
    assert sue_beliefunit.get_keg_obj(hr_19_rope).gogo_want == 1140
    assert sue_beliefunit.get_keg_obj(hr_20_rope).gogo_want == 1200
    assert sue_beliefunit.get_keg_obj(hr_21_rope).gogo_want == 1260
    assert sue_beliefunit.get_keg_obj(hr_22_rope).gogo_want == 1320
    assert sue_beliefunit.get_keg_obj(hr_23_rope).gogo_want == 1380
    assert sue_beliefunit.get_keg_obj(hr_00_rope).stop_want == 60
    assert sue_beliefunit.get_keg_obj(hr_01_rope).stop_want == 120
    assert sue_beliefunit.get_keg_obj(hr_02_rope).stop_want == 180
    assert sue_beliefunit.get_keg_obj(hr_03_rope).stop_want == 240
    assert sue_beliefunit.get_keg_obj(hr_04_rope).stop_want == 300
    assert sue_beliefunit.get_keg_obj(hr_05_rope).stop_want == 360
    assert sue_beliefunit.get_keg_obj(hr_06_rope).stop_want == 420
    assert sue_beliefunit.get_keg_obj(hr_07_rope).stop_want == 480
    assert sue_beliefunit.get_keg_obj(hr_08_rope).stop_want == 540
    assert sue_beliefunit.get_keg_obj(hr_09_rope).stop_want == 600
    assert sue_beliefunit.get_keg_obj(hr_10_rope).stop_want == 660
    assert sue_beliefunit.get_keg_obj(hr_11_rope).stop_want == 720
    assert sue_beliefunit.get_keg_obj(hr_12_rope).stop_want == 780
    assert sue_beliefunit.get_keg_obj(hr_13_rope).stop_want == 840
    assert sue_beliefunit.get_keg_obj(hr_14_rope).stop_want == 900
    assert sue_beliefunit.get_keg_obj(hr_15_rope).stop_want == 960
    assert sue_beliefunit.get_keg_obj(hr_16_rope).stop_want == 1020
    assert sue_beliefunit.get_keg_obj(hr_17_rope).stop_want == 1080
    assert sue_beliefunit.get_keg_obj(hr_18_rope).stop_want == 1140
    assert sue_beliefunit.get_keg_obj(hr_19_rope).stop_want == 1200
    assert sue_beliefunit.get_keg_obj(hr_20_rope).stop_want == 1260
    assert sue_beliefunit.get_keg_obj(hr_21_rope).stop_want == 1320
    assert sue_beliefunit.get_keg_obj(hr_22_rope).stop_want == 1380
    assert sue_beliefunit.get_keg_obj(hr_23_rope).stop_want == 1440
...
def test_add_time_creg_kegunit_ReturnsObjWith_offset_KegUnits():
    ...
    five_rope = sue_belief.make_rope(time_rope, kw.five)
    creg_yr1_jan1_offset_rope = sue_belief.make_rope(creg_rope, kw.yr1_jan1_offset)
    five_yr1_jan1_offset_rope = sue_belief.make_rope(five_rope, kw.yr1_jan1_offset)

    assert sue_belief.keg_exists(creg_yr1_jan1_offset_rope)
    creg_yr1_offset_keg = sue_belief.get_keg_obj(creg_yr1_jan1_offset_rope)
    assert creg_yr1_offset_keg.addin == get_creg_config().get(kw.yr1_jan1_offset)
    assert not sue_belief.keg_exists(five_yr1_jan1_offset_rope)
    ...
    # THEN
    assert sue_belief.keg_exists(creg_yr1_jan1_offset_rope)
    assert sue_belief.keg_exists(five_yr1_jan1_offset_rope)
    five_yr1_offset_keg = sue_belief.get_keg_obj(five_yr1_jan1_offset_rope)
...
def test_add_epoch_kegunit_SetsAttr_Scenario0():
    ...
    creg_rope = sue_belief.make_rope(time_rope, kw.creg)
    creg_yr1_jan1_offset_rope = sue_belief.make_rope(creg_rope, kw.yr1_jan1_offset)
    creg_year_rope = get_year_rope(sue_belief, kw.creg)
    print(f"{creg_year_rope=}")
    # print(f"{sue_belief._keg_dict.keys()=}")
    creg_config = get_creg_config()

    assert not sue_belief.keg_exists(creg_year_rope)
    assert not sue_belief.keg_exists(creg_yr1_jan1_offset_rope)

    # WHEN
    add_epoch_kegunit(sue_belief, creg_config)

    # THEN
    assert sue_belief.keg_exists(creg_year_rope)
    assert sue_belief.keg_exists(creg_yr1_jan1_offset_rope)
    creg_offset_keg = sue_belief.get_keg_obj(creg_yr1_jan1_offset_rope)
    assert creg_offset_keg.addin == creg_config.get(kw.yr1_jan1_offset)


# def test_BeliefUnit_get_keg_ranged_kids_ReturnsSomeChildrenScenario2():
#     # ESTABLISH
#     sue_beliefunit = beliefunit_shop("Sue")
#     sue_beliefunit.set_time_creg_kegs(c400_number=7)
...
#     assert len(sue_beliefunit.get_keg_ranged_kids(week_rope, begin=0, close=1440)) == 1
#     assert len(sue_beliefunit.get_keg_ranged_kids(week_rope, begin=0, close=2000)) == 2
#     assert len(sue_beliefunit.get_keg_ranged_kids(week_rope, begin=0, close=3000)) == 3


# def test_BeliefUnit_get_keg_ranged_kids_ReturnsSomeChildrenScenario3():
#     # ESTABLISH
#     sue_beliefunit = beliefunit_shop("Sue")
#     sue_beliefunit.set_time_creg_kegs(c400_number=7)
...
#     tech_rope = sue_beliefunit.make_rope(time_rope, "tech")
#     week_rope = sue_beliefunit.make_rope(tech_rope, "week")
#     assert len(sue_beliefunit.get_keg_ranged_kids(keg_rope=week_rope, begin=0)) == 1
#     assert len(sue_beliefunit.get_keg_ranged_kids(keg_rope=week_rope, begin=1440)) == 1


def test_BeliefUnit_get_agenda_dict_DoesNotReturnPledgeKegsOutsideRange():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    sue_belief = add_time_creg_kegunit(beliefunit_shop(exx.sue))
    clean_rope = sue_belief.make_l1_rope(exx.clean)
    sue_belief.set_l1_keg(kegunit_shop(exx.clean, pledge=True))
    ...
    # print(f"{sue_belief.kegroot.factunits=}")
...
def test_BeliefUnit_create_agenda_keg_CreatesAllBeliefAttributes():
    ...
    add_time_creg_kegunit(sue_belief)
    time_rope = sue_belief.make_l1_rope("time")
    cregtime_rope = sue_belief.make_rope(time_rope, kw.creg)
    creg_keg = sue_belief.get_keg_obj(cregtime_rope)
    ...
    assert len(sue_belief.voices) == 0
    assert len(sue_belief.get_voiceunit_group_titles_dict()) == 0
    assert len(sue_belief.kegroot.kids) == 1
    assert sue_belief.get_keg_obj(daytime_rope).denom == 1440
    assert sue_belief.get_keg_obj(daytime_rope).morph
    print(f"{sweep_keg.get_keg_rope()=}")

    # ESTABLISH
    sue_belief.set_dominate_pledge_keg(keg_kid=sweep_keg)

    # THEN
    # for keg_kid in sue_belief.kegroot.kids.keys():
    #     print(f"  {keg_kid=}")

    print(f"{sweep_keg.get_keg_rope()=}")
    assert sue_belief.get_keg_obj(sweep_rope) is not None
    assert sue_belief.get_keg_obj(sweep_rope).keg_label == sweep_str
    assert sue_belief.get_keg_obj(sweep_rope).pledge
    assert len(sue_belief.get_keg_obj(sweep_rope).reasonunits) == 2
    assert sue_belief.get_keg_obj(clean_rope) is not None
    assert sue_belief.get_keg_obj(cuisine_room_rope) is not None
    assert sue_belief.get_keg_obj(cuisine_dirty_rope) is not None
    assert len(sue_belief.get_voiceunit_group_titles_dict()) == 0
    assert sue_belief.get_voiceunit_group_titles_dict().get(family_str) is None

    assert len(sue_belief.kegroot.kids) == 3
...
def test_KegCore_get_agenda_dict_ReturnsObj_BugFindAndFix_active_SettingError():  # https://github.com/jschalk/beto/issues/69
    ...
    sue_belief.set_keg_obj(kegunit_shop(laundry_str, pledge=True), casa_rope)
    time_rope = sue_belief.make_l1_rope("time")
    cregtime_rope = sue_belief.make_rope(time_rope, kw.creg)
    sue_belief.edit_keg_attr(
        laundry_rope,
    ...
    laundry_keg = sue_belief.get_keg_obj(laundry_rope)
    ...
    # for x_kegunit in sue_belief._keg_dict.values():
...
def test_add_time_five_kegunit_SetsAttr_Scenario0_AddsMultiple_epochs():
    ...
    five_yr1_jan1_offset_rope = sue_belief.make_rope(five_rope, kw.yr1_jan1_offset)
    creg_year_rope = get_year_rope(sue_belief, kw.creg)
    five_year_rope = get_year_rope(sue_belief, kw.five)
    print(f"{creg_year_rope=}")
    print(f"{five_year_rope=}")
    # print(f"{sue_belief._keg_dict.keys()=}")

    assert not sue_belief.keg_exists(five_year_rope)
    assert sue_belief.keg_exists(creg_year_rope)
    assert sue_belief.keg_exists(creg_yr1_jan1_offset_rope)
    creg_offset_keg = sue_belief.get_keg_obj(creg_yr1_jan1_offset_rope)
    ...
    # THEN
    assert sue_belief.keg_exists(five_year_rope)
    assert sue_belief.keg_exists(creg_year_rope)
    assert sue_belief.keg_exists(creg_yr1_jan1_offset_rope)
    assert sue_belief.keg_exists(five_yr1_jan1_offset_rope)
    five_offset_keg = sue_belief.get_keg_obj(five_yr1_jan1_offset_rope)
