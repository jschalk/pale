...
def test_PlanUnit_set_keg_dict_SetsAll_range_inheritors():
    # ESTABLISH
    ...
    assert sue_planunit.range_inheritors == {}
    ...
    # THEN
    print(f"{sue_planunit.range_inheritors=}")
    assert sue_planunit.range_inheritors != {}
    assert day_rope in sue_planunit.range_inheritors
    assert weeks_rope in sue_planunit.range_inheritors
...
def test_PlanUnit_set_kegtree_range_attrs_Sets_day_keg_gogo_calc_stop_calc():
    # ESTABLISH
    sue_planunit = planunit_shop("Sue")
    time_rope = sue_planunit.make_l1_rope(kw.time)
    creg_rope = sue_planunit.make_rope(time_rope, kw.creg)
...
def test_PlanUnit_set_kegtree_range_attrs_Sets_days_keg_gogo_calc_stop_calc():
    # ESTABLISH
    sue_planunit = planunit_shop("Sue")
    time_rope = sue_planunit.make_l1_rope(kw.time)
    creg_rope = sue_planunit.make_rope(time_rope, kw.creg)
...
def test_PlanUnit_set_kegtree_range_attrs_Sets_weeks_keg_gogo_calc_stop_calc():
    # ESTABLISH
    sue_planunit = planunit_shop("Sue")
    time_rope = sue_planunit.make_l1_rope(kw.time)
    creg_rope = sue_planunit.make_rope(time_rope, kw.creg)
    ...
    assert sue_planunit.get_keg_obj(sun_rope).gogo_calc == 5760
    assert sue_planunit.get_keg_obj(mon_rope).gogo_calc == 7200
    assert sue_planunit.get_keg_obj(tue_rope).gogo_calc == 8640
    assert sue_planunit.get_keg_obj(wed_rope).gogo_calc == 0
    assert sue_planunit.get_keg_obj(thu_rope).gogo_calc == 1440
    assert sue_planunit.get_keg_obj(fri_rope).gogo_calc == 2880
    assert sue_planunit.get_keg_obj(sat_rope).gogo_calc == 4320
    assert sue_planunit.get_keg_obj(sun_rope).stop_calc == 7200
    assert sue_planunit.get_keg_obj(mon_rope).stop_calc == 8640
    assert sue_planunit.get_keg_obj(tue_rope).stop_calc == 10080
    assert sue_planunit.get_keg_obj(wed_rope).stop_calc == 1440
    assert sue_planunit.get_keg_obj(thu_rope).stop_calc == 2880
    assert sue_planunit.get_keg_obj(fri_rope).stop_calc == 4320
    assert sue_planunit.get_keg_obj(sat_rope).stop_calc == 5760


def test_PlanUnit_set_kegtree_range_attrs_Sets_c400_keg_gogo_calc_stop_calc():
    # ESTABLISH
    sue_planunit = planunit_shop("Sue")
    time_rope = sue_planunit.make_l1_rope(kw.time)
    creg_rope = sue_planunit.make_rope(time_rope, kw.creg)
    ...
    assert 1472657760 % sue_planunit.get_keg_obj(c400_leap_rope).stop_calc == 0


def test_PlanUnit_set_kegtree_range_attrs_Sets_years_keg_gogo_calc_stop_calc():
    # ESTABLISH
    sue_planunit = planunit_shop("Sue")
    time_rope = sue_planunit.make_l1_rope(kw.time)
    creg_rope = sue_planunit.make_rope(time_rope, kw.creg)
    ...
    assert sue_planunit.get_keg_obj(jan_rope).gogo_calc == 440640
    assert sue_planunit.get_keg_obj(feb_rope).gogo_calc == 485280
    assert sue_planunit.get_keg_obj(mar_rope).gogo_calc == 0
    assert sue_planunit.get_keg_obj(apr_rope).gogo_calc == 44640
    assert sue_planunit.get_keg_obj(may_rope).gogo_calc == 87840
    assert sue_planunit.get_keg_obj(jun_rope).gogo_calc == 132480
    assert sue_planunit.get_keg_obj(jul_rope).gogo_calc == 175680
    assert sue_planunit.get_keg_obj(aug_rope).gogo_calc == 220320
    assert sue_planunit.get_keg_obj(sep_rope).gogo_calc == 264960
    assert sue_planunit.get_keg_obj(oct_rope).gogo_calc == 308160
    assert sue_planunit.get_keg_obj(nov_rope).gogo_calc == 352800
    assert sue_planunit.get_keg_obj(dec_rope).gogo_calc == 396000

    assert sue_planunit.get_keg_obj(jan_rope).stop_calc == 485280
    assert sue_planunit.get_keg_obj(feb_rope).stop_calc == 525600
    assert sue_planunit.get_keg_obj(mar_rope).stop_calc == 44640
    assert sue_planunit.get_keg_obj(apr_rope).stop_calc == 87840
    assert sue_planunit.get_keg_obj(may_rope).stop_calc == 132480
    assert sue_planunit.get_keg_obj(jun_rope).stop_calc == 175680
    assert sue_planunit.get_keg_obj(jul_rope).stop_calc == 220320
    assert sue_planunit.get_keg_obj(aug_rope).stop_calc == 264960
    assert sue_planunit.get_keg_obj(sep_rope).stop_calc == 308160
    assert sue_planunit.get_keg_obj(oct_rope).stop_calc == 352800
    assert sue_planunit.get_keg_obj(nov_rope).stop_calc == 396000
    assert sue_planunit.get_keg_obj(dec_rope).stop_calc == 440640
