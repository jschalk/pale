from src.ch13_epoch.epoch_main import get_first_weekday_index_of_year
from src.ch13_epoch.test._util.ch13_examples import get_creg_config, get_five_config
