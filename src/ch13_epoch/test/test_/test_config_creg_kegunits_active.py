...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario0():
    # ESTABLISH
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario1():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_day_keg_Scenario2():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_days_keg_Scenario0():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
    ...
    # THEN
    clean_keg = sue_beliefunit.get_keg_obj(clean_rope)
    print(f"{clean_keg.factheirs.keys()=}")
    print(f"{clean_keg.factheirs.get(days_rope)=}")
    assert sue_agenda.get(clean_rope)


def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_week_keg_Scenario0():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_week_keg_Scenario1():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_weeks_keg_Scenario0():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario0():
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario1():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_get_agenda_dict_ReturnsDictWith_year_keg_Scenario2():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def test_BeliefUnit_add_time_creg_kegunit_SyncsWeekDayAndYear_Wednesday_March1_2000():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
...
def change_fact_print_attrs(x_beliefunit: BeliefUnit, x_lower: float, x_upper: float):
    ...
    clean_keg = x_beliefunit.get_keg_obj(clean_rope)
...
def test_BeliefUnit_add_time_creg_kegunit_SyncsWeekDayAndYear_Thursday_March2_2000():
    # ESTABLISH
    sue_beliefunit = beliefunit_shop("Sue")
    time_rope = sue_beliefunit.make_l1_rope(kw.time)
    creg_rope = sue_beliefunit.make_rope(time_rope, kw.creg)
