...
- ch04_rope: ContextNum, KnotTerm, ManaGrain, knot, mana_grain
...
- ch07_belief_logic: BeliefName, MomentLabel, ancestors, belief_groupunit, belief_plan_awardunit, belief_plan_factunit, belief_plan_healerunit, belief_plan_partyunit, belief_plan_reason_caseunit, belief_plan_reasonunit, belief_planunit, belief_voice_membership, belief_voiceunit, beliefunit, class_type, credor_respect, debtor_respect, dimen, dimens, jkeys, jvalues, keep_rope, keeps_buildable, keeps_justified, last_lesson_id, mandate, max_tree_traverse, moment, moment_label, offtrack_fund, offtrack_kids_star_set, planroot, reason_contexts, sum_healerunit_plans_fund_total, tally, voice_pool, voices
- ch08_belief_atom: CRUD_command, DELETE, atom, atom_hx, column_order, crud, nesting_order, normal_specs, normal_table_name
- ch09_belief_lesson: FaceName, face_name, gut, job, moment_mstr_dir, spark_num
- ch10_belief_listen: 
- ch11_bud: Epoch, EpochTime, SparkInt, amount, beliefadjust, beliefspark_facts, boss_facts, bud_belief_name, bud_time, bud_voice_nets, celldepth, epoch, found_facts, magnitude, offi_time, offi_time_max, quota, time, tran_time
- ch12_keep: ManaNum, care_amount, cares, cycle_carees_curr, cycle_carees_prev, cycle_count, cycle_max, doctor_count, doctor_rank_num, doctor_rank_percent, keep_patientledgers, keep_point_magnitude, need_bill_amount, need_dues, need_got_curr, need_got_prev, need_paid_amount, need_paid_bool, need_paid_rank_num, need_paid_rank_percent, need_yields, patient_count, patient_rank_num, patient_rank_percent, rewards_count, rewards_magnitude, riverbooks, rivercares, rivergrades
...
- ch14_moment: all_tranbook, beliefbudhistorys, cumulative_minute, hour_label, job_listen_rotations, moment_budunit, moment_epoch_hour, moment_epoch_month, moment_epoch_weekday, moment_paybook, moment_static, moment_timeoffi, momentunit, offi_times, paybook, weekday_label, weekday_order
- ch15_forge: Forge, EpochForge, forge, epochforge, inx_epoch_diff, otx2inx, otx_epoch_length
- ch16_translate: inx_knot, inx_label, inx_name, inx_rope, inx_title, labelmap, namemap, otx_knot, otx_label, otx_name, otx_rope, otx_title, ropemap, titlemap, translate, translate_category, translate_core, translate_epoch, translate_label, translate_name, translate_rope, translate_title, translateunit, unknown_str
- ch17_idea: allowed_crud, attributes, bnet_funds, build_order, delete_insert, delete_insert_update, delete_update, error_message, fund_rank, idea_category, idea_number, insert_multiple, insert_one_time, insert_update, otx_key, pledges_count, source_dimen, translate_spark_num, world_name
