...
- ch07_plan_logic: MomentRope, PlanName, ancestors, ch07, class_type, credor_respect, debtor_respect, dimen, dimens, jkeys, jvalues, keep_rope, keeps_buildable, keeps_justified, kegroot, last_lesson_id, mandate, max_tree_traverse, moment, moment_rope, offtrack_fund, offtrack_kids_star_set, person_pool, persons, plan_groupunit, plan_keg_awardunit, plan_keg_factunit, plan_keg_healerunit, plan_keg_partyunit, plan_keg_reason_caseunit, plan_keg_reasonunit, plan_kegunit, plan_person_membership, plan_personunit, planunit, reason_contexts, sum_healerunit_kegs_fund_total, tally
