...
- ch07_plan_logic: MomentLabel, PlanName, ancestors, ch07, class_type, credor_respect, debtor_respect, dimen, dimens, jkeys, jvalues, keep_rope, keeps_buildable, keeps_justified, kegroot, last_lesson_id, mandate, max_tree_traverse, moment, moment_label, offtrack_fund, offtrack_kids_star_set, person_pool, persons, plan_groupunit, plan_keg_awardunit, plan_keg_factunit, plan_keg_healerunit, plan_keg_partyunit, plan_keg_reason_caseunit, plan_keg_reasonunit, plan_kegunit, plan_person_membership, plan_personunit, planunit, reason_contexts, sum_healerunit_kegs_fund_total, tally
...
- ch11_bud: Epoch, EpochTime, SparkInt, amount, boss_facts, bud_person_nets, bud_plan_name, bud_time, celldepth, ch11, epoch, found_facts, magnitude, offi_time, offi_time_max, planadjust, planspark_facts, quota, time, tran_time
...
- ch18_world_etl: brick_agg, brick_raw, brick_valid, ch18, heard_raw, heard_vld, moment_ote1_agg, moment_person_nets, plan_net_amount, sound_agg, sound_raw, sparks_brick_agg, sparks_brick_valid
