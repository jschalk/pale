...
- ch11_belief_listen: 
- ch12_bud: Epoch, EpochTime, SparkInt, amount, beliefadjust, beliefspark_facts, boss_facts, bud_belief_name, bud_time, bud_voice_nets, celldepth, epoch, found_facts, magnitude, offi_time, offi_time_max, quota, time, tran_time
...
- ch14_epoch: Anaday, Baileyday, Chiday, Danceday, Eastday, EpochLabel, Friday, Monday, Saturday, Sunday, Thursday, Tuesday, Wednesday, c100, c400_clean, c400_leap, c400_number, creg, cumulative_day, day, dayly_duration_min, dayly_lower_min, days, days_lower_day, days_upper_day, duration, epoch_label, epoch_length_min, every_xdays, every_xweeks, five, hour, hours_config, month_label, monthday_index, monthly_duration_days, monthly_monthday_lower, months_config, range_duration, range_lower_min, readable, week, weekdays_config, weekly_duration_min, weekly_lower_min, weeks, weeks_lower_week, weeks_upper_week, year, year_monthday_duration_days, year_monthday_lower, yr1_jan1_offset, yr4_clean, yr4_leap
- ch15_moment: all_tranbook, beliefbudhistorys, cumulative_minute, hour_label, job_listen_rotations, moment_budunit, moment_epoch_hour, moment_epoch_month, moment_epoch_weekday, moment_paybook, moment_static, moment_timeoffi, momentunit, offi_times, paybook, weekday_label, weekday_order
- ch16_translate: EpochFormula, inx_knot, inx_label, inx_name, inx_rope, inx_time, inx_title, otx2inx, otx_knot, otx_label, otx_name, otx_rope, otx_time, otx_title, time_modulus, translate, translate_category, translate_core, translate_epoch, translate_label, translate_name, translate_rope, translate_title, translateunit, unknown_str
