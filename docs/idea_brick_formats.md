...
- [`br00013`](ideas\br00013.md): spark_num, face_name, moment_label, belief_name, keg_rope, star, pledge
- [`br00019`](ideas\br00019.md): spark_num, face_name, moment_label, belief_name, keg_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want
...
- [`br00022`](ideas\br00022.md): spark_num, face_name, moment_label, belief_name, keg_rope, awardee_title, give_force, take_force
- [`br00023`](ideas\br00023.md): spark_num, face_name, moment_label, belief_name, keg_rope, fact_context, fact_state, fact_lower, fact_upper
- [`br00024`](ideas\br00024.md): spark_num, face_name, moment_label, belief_name, keg_rope, party_title, solo
- [`br00025`](ideas\br00025.md): spark_num, face_name, moment_label, belief_name, keg_rope, healer_name
- [`br00026`](ideas\br00026.md): spark_num, face_name, moment_label, belief_name, keg_rope, reason_context, reason_state, reason_lower, reason_upper, reason_divisor
- [`br00027`](ideas\br00027.md): spark_num, face_name, moment_label, belief_name, keg_rope, reason_context, active_requisite
- [`br00028`](ideas\br00028.md): spark_num, face_name, moment_label, belief_name, keg_rope, begin, close, addin, numor, denom, morph, gogo_want, stop_want, star, pledge, problem_bool
...
- [`br00036`](ideas\br00036.md): spark_num, face_name, moment_label, belief_name, keg_rope, healer_name, problem_bool
...
- [`br00052`](ideas\br00052.md): spark_num, face_name, moment_label, belief_name, keg_rope, awardee_title_ERASE
- [`br00053`](ideas\br00053.md): spark_num, face_name, moment_label, belief_name, keg_rope, fact_context_ERASE
- [`br00054`](ideas\br00054.md): spark_num, face_name, moment_label, belief_name, keg_rope, party_title_ERASE
- [`br00055`](ideas\br00055.md): spark_num, face_name, moment_label, belief_name, keg_rope, healer_name_ERASE
- [`br00056`](ideas\br00056.md): spark_num, face_name, moment_label, belief_name, keg_rope, reason_context, reason_state_ERASE
- [`br00057`](ideas\br00057.md): spark_num, face_name, moment_label, belief_name, keg_rope, reason_context_ERASE
- [`br00058`](ideas\br00058.md): spark_num, face_name, moment_label, belief_name, keg_rope_ERASE
